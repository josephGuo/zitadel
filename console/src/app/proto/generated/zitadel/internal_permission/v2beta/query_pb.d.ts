...
export class AdministratorSearchFilter extends jspb.Message {
  getCreationDate(): zitadel_filter_v2beta_filter_pb.TimestampFilter | undefined;
  setCreationDate(value?: zitadel_filter_v2beta_filter_pb.TimestampFilter): AdministratorSearchFilter;
  hasCreationDate(): boolean;
  clearCreationDate(): AdministratorSearchFilter;

  getChangeDate(): zitadel_filter_v2beta_filter_pb.TimestampFilter | undefined;
  setChangeDate(value?: zitadel_filter_v2beta_filter_pb.TimestampFilter): AdministratorSearchFilter;
  hasChangeDate(): boolean;
  clearChangeDate(): AdministratorSearchFilter;

  getInUserIdsFilter(): zitadel_filter_v2beta_filter_pb.InIDsFilter | undefined;
  setInUserIdsFilter(value?: zitadel_filter_v2beta_filter_pb.InIDsFilter): AdministratorSearchFilter;
  ...
  setUserOrganizationId(value?: zitadel_filter_v2beta_filter_pb.IDFilter): AdministratorSearchFilter;
...
export namespace AdministratorSearchFilter {
  export type AsObject = {
    creationDate?: zitadel_filter_v2beta_filter_pb.TimestampFilter.AsObject,
    changeDate?: zitadel_filter_v2beta_filter_pb.TimestampFilter.AsObject,
    inUserIdsFilter?: zitadel_filter_v2beta_filter_pb.InIDsFilter.AsObject,
...
export class UserPreferredLoginNameFilter extends jspb.Message {
  ...
  setMethod(value: zitadel_filter_v2beta_filter_pb.TextFilterMethod): UserPreferredLoginNameFilter;
...
export class UserDisplayNameFilter extends jspb.Message {
  ...
  getMethod(): zitadel_filter_v2beta_filter_pb.TextFilterMethod;
  setMethod(value: zitadel_filter_v2beta_filter_pb.TextFilterMethod): UserDisplayNameFilter;
...
export class ResourceFilter extends jspb.Message {
  ...
  setProjectGrantId(value: string): ResourceFilter;
