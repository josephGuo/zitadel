...
import * as zitadel_internal_permission_v2_query_pb from '../../../zitadel/internal_permission/v2/query_pb'; // proto import: "zitadel/internal_permission/v2/query.proto"
...
export class ListAdministratorsRequest extends jspb.Message {
  ...
  setPagination(value?: zitadel_filter_v2_filter_pb.PaginationRequest): ListAdministratorsRequest;
  hasPagination(): boolean;
  clearPagination(): ListAdministratorsRequest;

  getSortingColumn(): zitadel_internal_permission_v2_query_pb.AdministratorFieldName;
  setSortingColumn(value: zitadel_internal_permission_v2_query_pb.AdministratorFieldName): ListAdministratorsRequest;

  getFiltersList(): Array<zitadel_internal_permission_v2_query_pb.AdministratorSearchFilter>;
  setFiltersList(value: Array<zitadel_internal_permission_v2_query_pb.AdministratorSearchFilter>): ListAdministratorsRequest;
  clearFiltersList(): ListAdministratorsRequest;
  addFilters(value?: zitadel_internal_permission_v2_query_pb.AdministratorSearchFilter, index?: number): zitadel_internal_permission_v2_query_pb.AdministratorSearchFilter;
...
export namespace ListAdministratorsRequest {
  export type AsObject = {
    ...
    sortingColumn: zitadel_internal_permission_v2_query_pb.AdministratorFieldName,
    filtersList: Array<zitadel_internal_permission_v2_query_pb.AdministratorSearchFilter.AsObject>,
  }
...
export class ListAdministratorsResponse extends jspb.Message {
  ...
  setPagination(value?: zitadel_filter_v2_filter_pb.PaginationResponse): ListAdministratorsResponse;
  hasPagination(): boolean;
  clearPagination(): ListAdministratorsResponse;

  getAdministratorsList(): Array<zitadel_internal_permission_v2_query_pb.Administrator>;
  setAdministratorsList(value: Array<zitadel_internal_permission_v2_query_pb.Administrator>): ListAdministratorsResponse;
  clearAdministratorsList(): ListAdministratorsResponse;
  addAdministrators(value?: zitadel_internal_permission_v2_query_pb.Administrator, index?: number): zitadel_internal_permission_v2_query_pb.Administrator;
...
export namespace ListAdministratorsResponse {
  export type AsObject = {
    ...
    administratorsList: Array<zitadel_internal_permission_v2_query_pb.Administrator.AsObject>,
  }
}
