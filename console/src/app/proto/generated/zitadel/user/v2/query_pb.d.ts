...
export class SearchQuery extends jspb.Message {
  ...
  getMetadataKeyFilter(): zitadel_metadata_v2_metadata_pb.MetadataKeyFilter | undefined;
  setMetadataKeyFilter(value?: zitadel_metadata_v2_metadata_pb.MetadataKeyFilter): SearchQuery;
  hasMetadataKeyFilter(): boolean;
  clearMetadataKeyFilter(): SearchQuery;

  getMetadataValueFilter(): zitadel_metadata_v2_metadata_pb.MetadataValueFilter | undefined;
  setMetadataValueFilter(value?: zitadel_metadata_v2_metadata_pb.MetadataValueFilter): SearchQuery;
  hasMetadataValueFilter(): boolean;
  clearMetadataValueFilter(): SearchQuery;
...
export namespace SearchQuery {
  export type AsObject = {
    ...
    metadataKeyFilter?: zitadel_metadata_v2_metadata_pb.MetadataKeyFilter.AsObject,
    metadataValueFilter?: zitadel_metadata_v2_metadata_pb.MetadataValueFilter.AsObject,
  }
...
export class UserNameQuery extends jspb.Message {
  ...
  setMethod(value: zitadel_object_v2_object_pb.TextQueryMethod): UserNameQuery;
...
export class FirstNameQuery extends jspb.Message {
  ...
  getMethod(): zitadel_object_v2_object_pb.TextQueryMethod;
  setMethod(value: zitadel_object_v2_object_pb.TextQueryMethod): FirstNameQuery;
...
export class LastNameQuery extends jspb.Message {
  ...
  getMethod(): zitadel_object_v2_object_pb.TextQueryMethod;
  setMethod(value: zitadel_object_v2_object_pb.TextQueryMethod): LastNameQuery;
...
export class NickNameQuery extends jspb.Message {
  ...
  getMethod(): zitadel_object_v2_object_pb.TextQueryMethod;
  setMethod(value: zitadel_object_v2_object_pb.TextQueryMethod): NickNameQuery;
...
export class DisplayNameQuery extends jspb.Message {
  ...
  getMethod(): zitadel_object_v2_object_pb.TextQueryMethod;
  setMethod(value: zitadel_object_v2_object_pb.TextQueryMethod): DisplayNameQuery;
...
export class EmailQuery extends jspb.Message {
  ...
  getMethod(): zitadel_object_v2_object_pb.TextQueryMethod;
  setMethod(value: zitadel_object_v2_object_pb.TextQueryMethod): EmailQuery;
...
export class PhoneQuery extends jspb.Message {
  ...
  getMethod(): zitadel_object_v2_object_pb.TextQueryMethod;
  setMethod(value: zitadel_object_v2_object_pb.TextQueryMethod): PhoneQuery;
...
export class LoginNameQuery extends jspb.Message {
  ...
  getMethod(): zitadel_object_v2_object_pb.TextQueryMethod;
  setMethod(value: zitadel_object_v2_object_pb.TextQueryMethod): LoginNameQuery;
...
export class StateQuery extends jspb.Message {
  getState(): zitadel_user_v2_user_pb.UserState;
  setState(value: zitadel_user_v2_user_pb.UserState): StateQuery;
...
export namespace StateQuery {
  export type AsObject = {
    state: zitadel_user_v2_user_pb.UserState,
  }
}
