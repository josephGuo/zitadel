...
export class RemovePhoneResponse extends jspb.Message {
  getDetails(): zitadel_object_v2beta_object_pb.Details | undefined;
  setDetails(value?: zitadel_object_v2beta_object_pb.Details): RemovePhoneResponse;
  hasDetails(): boolean;
...
export class StartIdentityProviderIntentResponse extends jspb.Message {
  ...
  getFormData(): zitadel_user_v2beta_idp_pb.FormData | undefined;
  setFormData(value?: zitadel_user_v2beta_idp_pb.FormData): StartIdentityProviderIntentResponse;
  hasFormData(): boolean;
...
export namespace StartIdentityProviderIntentResponse {
  export type AsObject = {
    ...
    formData?: zitadel_user_v2beta_idp_pb.FormData.AsObject,
  }
