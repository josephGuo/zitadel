...
export class UserServiceClient {
  ...
  methodDescriptorRemovePhone = new grpcWeb.MethodDescriptor(
    ...
    grpcWeb.MethodType.UNARY,
    zitadel_user_v2beta_user_service_pb.RemovePhoneRequest,
    zitadel_user_v2beta_user_service_pb.RemovePhoneResponse,
    (request: zitadel_user_v2beta_user_service_pb.RemovePhoneRequest) => {
      return request.serializeBinary();
    },
    zitadel_user_v2beta_user_service_pb.RemovePhoneResponse.deserializeBinary
  );

  removePhone(
    request: zitadel_user_v2beta_user_service_pb.RemovePhoneRequest,
    metadata?: grpcWeb.Metadata | null): Promise<zitadel_user_v2beta_user_service_pb.RemovePhoneResponse>;

  removePhone(
    request: zitadel_user_v2beta_user_service_pb.RemovePhoneRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: zitadel_user_v2beta_user_service_pb.RemovePhoneResponse) => void): grpcWeb.ClientReadableStream<zitadel_user_v2beta_user_service_pb.RemovePhoneResponse>;

  removePhone(
    request: zitadel_user_v2beta_user_service_pb.RemovePhoneRequest,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: zitadel_user_v2beta_user_service_pb.RemovePhoneResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/zitadel.user.v2beta.UserService/RemovePhone',
