...
import * as zitadel_instance_v2_instance_pb from '../../../zitadel/instance/v2/instance_pb'; // proto import: "zitadel/instance/v2/instance.proto"
...
export class GetInstanceResponse extends jspb.Message {
  getInstance(): zitadel_instance_v2_instance_pb.Instance | undefined;
  setInstance(value?: zitadel_instance_v2_instance_pb.Instance): GetInstanceResponse;
  hasInstance(): boolean;
...
export namespace GetInstanceResponse {
  export type AsObject = {
    instance?: zitadel_instance_v2_instance_pb.Instance.AsObject,
  }
}
...
export class ListInstancesRequest extends jspb.Message {
  ...
  setPagination(value?: zitadel_filter_v2_filter_pb.PaginationRequest): ListInstancesRequest;
  hasPagination(): boolean;
  clearPagination(): ListInstancesRequest;

  getSortingColumn(): zitadel_instance_v2_instance_pb.FieldName;
  setSortingColumn(value: zitadel_instance_v2_instance_pb.FieldName): ListInstancesRequest;

  getFiltersList(): Array<zitadel_instance_v2_instance_pb.Filter>;
  setFiltersList(value: Array<zitadel_instance_v2_instance_pb.Filter>): ListInstancesRequest;
  clearFiltersList(): ListInstancesRequest;
  addFilters(value?: zitadel_instance_v2_instance_pb.Filter, index?: number): zitadel_instance_v2_instance_pb.Filter;
...
export namespace ListInstancesRequest {
  export type AsObject = {
    ...
    sortingColumn: zitadel_instance_v2_instance_pb.FieldName,
    filtersList: Array<zitadel_instance_v2_instance_pb.Filter.AsObject>,
  }
}

export class ListInstancesResponse extends jspb.Message {
  getInstancesList(): Array<zitadel_instance_v2_instance_pb.Instance>;
  setInstancesList(value: Array<zitadel_instance_v2_instance_pb.Instance>): ListInstancesResponse;
  clearInstancesList(): ListInstancesResponse;
  addInstances(value?: zitadel_instance_v2_instance_pb.Instance, index?: number): zitadel_instance_v2_instance_pb.Instance;

  getPagination(): zitadel_filter_v2_filter_pb.PaginationResponse | undefined;
  setPagination(value?: zitadel_filter_v2_filter_pb.PaginationResponse): ListInstancesResponse;
  hasPagination(): boolean;
...
export namespace ListInstancesResponse {
  export type AsObject = {
    instancesList: Array<zitadel_instance_v2_instance_pb.Instance.AsObject>,
...
export class AddCustomDomainRequest extends jspb.Message {
  ...
  setCustomDomain(value: string): AddCustomDomainRequest;
...
export class RemoveCustomDomainRequest extends jspb.Message {
  ...
  getCustomDomain(): string;
  setCustomDomain(value: string): RemoveCustomDomainRequest;
...
export class ListCustomDomainsRequest extends jspb.Message {
  ...
  getPagination(): zitadel_filter_v2_filter_pb.PaginationRequest | undefined;
  setPagination(value?: zitadel_filter_v2_filter_pb.PaginationRequest): ListCustomDomainsRequest;
  hasPagination(): boolean;
  clearPagination(): ListCustomDomainsRequest;

  getSortingColumn(): zitadel_instance_v2_instance_pb.DomainFieldName;
  setSortingColumn(value: zitadel_instance_v2_instance_pb.DomainFieldName): ListCustomDomainsRequest;

  getFiltersList(): Array<zitadel_instance_v2_instance_pb.CustomDomainFilter>;
  setFiltersList(value: Array<zitadel_instance_v2_instance_pb.CustomDomainFilter>): ListCustomDomainsRequest;
  clearFiltersList(): ListCustomDomainsRequest;
  addFilters(value?: zitadel_instance_v2_instance_pb.CustomDomainFilter, index?: number): zitadel_instance_v2_instance_pb.CustomDomainFilter;
...
export namespace ListCustomDomainsRequest {
  export type AsObject = {
    instanceId: string,
    pagination?: zitadel_filter_v2_filter_pb.PaginationRequest.AsObject,
    sortingColumn: zitadel_instance_v2_instance_pb.DomainFieldName,
    filtersList: Array<zitadel_instance_v2_instance_pb.CustomDomainFilter.AsObject>,
  }
}

export class ListCustomDomainsResponse extends jspb.Message {
  getDomainsList(): Array<zitadel_instance_v2_instance_pb.CustomDomain>;
  setDomainsList(value: Array<zitadel_instance_v2_instance_pb.CustomDomain>): ListCustomDomainsResponse;
  clearDomainsList(): ListCustomDomainsResponse;
  addDomains(value?: zitadel_instance_v2_instance_pb.CustomDomain, index?: number): zitadel_instance_v2_instance_pb.CustomDomain;

  getPagination(): zitadel_filter_v2_filter_pb.PaginationResponse | undefined;
  setPagination(value?: zitadel_filter_v2_filter_pb.PaginationResponse): ListCustomDomainsResponse;
  hasPagination(): boolean;
...
export namespace ListCustomDomainsResponse {
  export type AsObject = {
    domainsList: Array<zitadel_instance_v2_instance_pb.CustomDomain.AsObject>,
    pagination?: zitadel_filter_v2_filter_pb.PaginationResponse.AsObject,
  }
}
...
export class AddTrustedDomainRequest extends jspb.Message {
  ...
  setTrustedDomain(value: string): AddTrustedDomainRequest;
...
export class RemoveTrustedDomainRequest extends jspb.Message {
  ...
  getTrustedDomain(): string;
  setTrustedDomain(value: string): RemoveTrustedDomainRequest;
...
export class ListTrustedDomainsRequest extends jspb.Message {
  ...
  getPagination(): zitadel_filter_v2_filter_pb.PaginationRequest | undefined;
  setPagination(value?: zitadel_filter_v2_filter_pb.PaginationRequest): ListTrustedDomainsRequest;
  hasPagination(): boolean;
  clearPagination(): ListTrustedDomainsRequest;

  getSortingColumn(): zitadel_instance_v2_instance_pb.TrustedDomainFieldName;
  setSortingColumn(value: zitadel_instance_v2_instance_pb.TrustedDomainFieldName): ListTrustedDomainsRequest;

  getFiltersList(): Array<zitadel_instance_v2_instance_pb.TrustedDomainFilter>;
  setFiltersList(value: Array<zitadel_instance_v2_instance_pb.TrustedDomainFilter>): ListTrustedDomainsRequest;
  clearFiltersList(): ListTrustedDomainsRequest;
  addFilters(value?: zitadel_instance_v2_instance_pb.TrustedDomainFilter, index?: number): zitadel_instance_v2_instance_pb.TrustedDomainFilter;
...
export namespace ListTrustedDomainsRequest {
  export type AsObject = {
    instanceId: string,
    pagination?: zitadel_filter_v2_filter_pb.PaginationRequest.AsObject,
    sortingColumn: zitadel_instance_v2_instance_pb.TrustedDomainFieldName,
    filtersList: Array<zitadel_instance_v2_instance_pb.TrustedDomainFilter.AsObject>,
  }
}

export class ListTrustedDomainsResponse extends jspb.Message {
  getTrustedDomainList(): Array<zitadel_instance_v2_instance_pb.TrustedDomain>;
  setTrustedDomainList(value: Array<zitadel_instance_v2_instance_pb.TrustedDomain>): ListTrustedDomainsResponse;
  clearTrustedDomainList(): ListTrustedDomainsResponse;
  addTrustedDomain(value?: zitadel_instance_v2_instance_pb.TrustedDomain, index?: number): zitadel_instance_v2_instance_pb.TrustedDomain;

  getPagination(): zitadel_filter_v2_filter_pb.PaginationResponse | undefined;
  setPagination(value?: zitadel_filter_v2_filter_pb.PaginationResponse): ListTrustedDomainsResponse;
  hasPagination(): boolean;
...
export namespace ListTrustedDomainsResponse {
  export type AsObject = {
    trustedDomainList: Array<zitadel_instance_v2_instance_pb.TrustedDomain.AsObject>,
    pagination?: zitadel_filter_v2_filter_pb.PaginationResponse.AsObject,
  }
}
