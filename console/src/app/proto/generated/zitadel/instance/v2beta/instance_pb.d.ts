...
export class Domain extends jspb.Message {
  ...
  setInstanceId(value: string): Domain;

  getCreationDate(): google_protobuf_timestamp_pb.Timestamp | undefined;
  setCreationDate(value?: google_protobuf_timestamp_pb.Timestamp): Domain;
  hasCreationDate(): boolean;
  clearCreationDate(): Domain;
...
export class DomainQuery extends jspb.Message {
  ...
  setMethod(value: zitadel_object_v2_object_pb.TextQueryMethod): DomainQuery;
...
export class TrustedDomainSearchQuery extends jspb.Message {
  getDomainQuery(): DomainQuery | undefined;
  setDomainQuery(value?: DomainQuery): TrustedDomainSearchQuery;
  hasDomainQuery(): boolean;
  clearDomainQuery(): TrustedDomainSearchQuery;

  getQueryCase(): TrustedDomainSearchQuery.QueryCase;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): TrustedDomainSearchQuery.AsObject;
  static toObject(includeInstance: boolean, msg: TrustedDomainSearchQuery): TrustedDomainSearchQuery.AsObject;
  static serializeBinaryToWriter(message: TrustedDomainSearchQuery, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): TrustedDomainSearchQuery;
  static deserializeBinaryFromReader(message: TrustedDomainSearchQuery, reader: jspb.BinaryReader): TrustedDomainSearchQuery;
}

export namespace TrustedDomainSearchQuery {
  export type AsObject = {
    domainQuery?: DomainQuery.AsObject,
  }
