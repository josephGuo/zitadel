...
export class OIDCConfig extends jspb.Message {
  ...
  getLoginVersion(): LoginVersion | undefined;
  setLoginVersion(value?: LoginVersion): OIDCConfig;
...
export namespace OIDCConfig {
  export type AsObject = {
    ...
    loginVersion?: LoginVersion.AsObject,
  }
}
...
export class SAMLConfig extends jspb.Message {
  ...
  getLoginVersion(): LoginVersion | undefined;
  setLoginVersion(value?: LoginVersion): SAMLConfig;
  hasLoginVersion(): boolean;
