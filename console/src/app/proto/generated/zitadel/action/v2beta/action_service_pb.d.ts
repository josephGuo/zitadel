...
import * as zitadel_action_v2beta_target_pb from '../../../zitadel/action/v2beta/target_pb'; // proto import: "zitadel/action/v2beta/target.proto"
import * as zitadel_action_v2beta_execution_pb from '../../../zitadel/action/v2beta/execution_pb'; // proto import: "zitadel/action/v2beta/execution.proto"
import * as zitadel_action_v2beta_query_pb from '../../../zitadel/action/v2beta/query_pb'; // proto import: "zitadel/action/v2beta/query.proto"
...
export class CreateTargetRequest extends jspb.Message {
  ...
  getRestWebhook(): zitadel_action_v2beta_target_pb.RESTWebhook | undefined;
  setRestWebhook(value?: zitadel_action_v2beta_target_pb.RESTWebhook): CreateTargetRequest;
  hasRestWebhook(): boolean;
  clearRestWebhook(): CreateTargetRequest;

  getRestCall(): zitadel_action_v2beta_target_pb.RESTCall | undefined;
  setRestCall(value?: zitadel_action_v2beta_target_pb.RESTCall): CreateTargetRequest;
  hasRestCall(): boolean;
  clearRestCall(): CreateTargetRequest;

  getRestAsync(): zitadel_action_v2beta_target_pb.RESTAsync | undefined;
  setRestAsync(value?: zitadel_action_v2beta_target_pb.RESTAsync): CreateTargetRequest;
...
export namespace CreateTargetRequest {
  export type AsObject = {
    name: string,
    restWebhook?: zitadel_action_v2beta_target_pb.RESTWebhook.AsObject,
    restCall?: zitadel_action_v2beta_target_pb.RESTCall.AsObject,
    restAsync?: zitadel_action_v2beta_target_pb.RESTAsync.AsObject,
...
export class UpdateTargetRequest extends jspb.Message {
  ...
  getRestWebhook(): zitadel_action_v2beta_target_pb.RESTWebhook | undefined;
  setRestWebhook(value?: zitadel_action_v2beta_target_pb.RESTWebhook): UpdateTargetRequest;
  hasRestWebhook(): boolean;
  clearRestWebhook(): UpdateTargetRequest;

  getRestCall(): zitadel_action_v2beta_target_pb.RESTCall | undefined;
  setRestCall(value?: zitadel_action_v2beta_target_pb.RESTCall): UpdateTargetRequest;
  hasRestCall(): boolean;
  clearRestCall(): UpdateTargetRequest;

  getRestAsync(): zitadel_action_v2beta_target_pb.RESTAsync | undefined;
  setRestAsync(value?: zitadel_action_v2beta_target_pb.RESTAsync): UpdateTargetRequest;
  hasRestAsync(): boolean;
...
export class GetTargetResponse extends jspb.Message {
  getTarget(): zitadel_action_v2beta_target_pb.Target | undefined;
  setTarget(value?: zitadel_action_v2beta_target_pb.Target): GetTargetResponse;
  hasTarget(): boolean;
...
export namespace GetTargetResponse {
  export type AsObject = {
    target?: zitadel_action_v2beta_target_pb.Target.AsObject,
  }
}
...
export class ListTargetsRequest extends jspb.Message {
  ...
  setPagination(value?: zitadel_filter_v2beta_filter_pb.PaginationRequest): ListTargetsRequest;
  hasPagination(): boolean;
  clearPagination(): ListTargetsRequest;

  getSortingColumn(): zitadel_action_v2beta_query_pb.TargetFieldName;
  setSortingColumn(value: zitadel_action_v2beta_query_pb.TargetFieldName): ListTargetsRequest;
  hasSortingColumn(): boolean;
  clearSortingColumn(): ListTargetsRequest;

  getFiltersList(): Array<zitadel_action_v2beta_query_pb.TargetSearchFilter>;
  setFiltersList(value: Array<zitadel_action_v2beta_query_pb.TargetSearchFilter>): ListTargetsRequest;
  clearFiltersList(): ListTargetsRequest;
  addFilters(value?: zitadel_action_v2beta_query_pb.TargetSearchFilter, index?: number): zitadel_action_v2beta_query_pb.TargetSearchFilter;
...
export namespace ListTargetsRequest {
  export type AsObject = {
    ...
    sortingColumn?: zitadel_action_v2beta_query_pb.TargetFieldName,
    filtersList: Array<zitadel_action_v2beta_query_pb.TargetSearchFilter.AsObject>,
  }
...
export class ListTargetsResponse extends jspb.Message {
  ...
  setPagination(value?: zitadel_filter_v2beta_filter_pb.PaginationResponse): ListTargetsResponse;
  hasPagination(): boolean;
  clearPagination(): ListTargetsResponse;

  getTargetsList(): Array<zitadel_action_v2beta_target_pb.Target>;
  setTargetsList(value: Array<zitadel_action_v2beta_target_pb.Target>): ListTargetsResponse;
  clearTargetsList(): ListTargetsResponse;
  addTargets(value?: zitadel_action_v2beta_target_pb.Target, index?: number): zitadel_action_v2beta_target_pb.Target;
...
export namespace ListTargetsResponse {
  export type AsObject = {
    ...
    targetsList: Array<zitadel_action_v2beta_target_pb.Target.AsObject>,
  }
}

export class SetExecutionRequest extends jspb.Message {
  getCondition(): zitadel_action_v2beta_execution_pb.Condition | undefined;
  setCondition(value?: zitadel_action_v2beta_execution_pb.Condition): SetExecutionRequest;
...
export namespace SetExecutionRequest {
  export type AsObject = {
    condition?: zitadel_action_v2beta_execution_pb.Condition.AsObject,
...
export class ListExecutionsRequest extends jspb.Message {
  getPagination(): zitadel_filter_v2beta_filter_pb.PaginationRequest | undefined;
  setPagination(value?: zitadel_filter_v2beta_filter_pb.PaginationRequest): ListExecutionsRequest;
  hasPagination(): boolean;
  clearPagination(): ListExecutionsRequest;

  getSortingColumn(): zitadel_action_v2beta_query_pb.ExecutionFieldName;
  setSortingColumn(value: zitadel_action_v2beta_query_pb.ExecutionFieldName): ListExecutionsRequest;
  hasSortingColumn(): boolean;
  clearSortingColumn(): ListExecutionsRequest;

  getFiltersList(): Array<zitadel_action_v2beta_query_pb.ExecutionSearchFilter>;
  setFiltersList(value: Array<zitadel_action_v2beta_query_pb.ExecutionSearchFilter>): ListExecutionsRequest;
  clearFiltersList(): ListExecutionsRequest;
  addFilters(value?: zitadel_action_v2beta_query_pb.ExecutionSearchFilter, index?: number): zitadel_action_v2beta_query_pb.ExecutionSearchFilter;
...
export namespace ListExecutionsRequest {
  export type AsObject = {
    pagination?: zitadel_filter_v2beta_filter_pb.PaginationRequest.AsObject,
    sortingColumn?: zitadel_action_v2beta_query_pb.ExecutionFieldName,
    filtersList: Array<zitadel_action_v2beta_query_pb.ExecutionSearchFilter.AsObject>,
  }
...
export class ListExecutionsResponse extends jspb.Message {
  getPagination(): zitadel_filter_v2beta_filter_pb.PaginationResponse | undefined;
  setPagination(value?: zitadel_filter_v2beta_filter_pb.PaginationResponse): ListExecutionsResponse;
  hasPagination(): boolean;
  clearPagination(): ListExecutionsResponse;

  getExecutionsList(): Array<zitadel_action_v2beta_execution_pb.Execution>;
  setExecutionsList(value: Array<zitadel_action_v2beta_execution_pb.Execution>): ListExecutionsResponse;
  clearExecutionsList(): ListExecutionsResponse;
  addExecutions(value?: zitadel_action_v2beta_execution_pb.Execution, index?: number): zitadel_action_v2beta_execution_pb.Execution;
...
export namespace ListExecutionsResponse {
  export type AsObject = {
    pagination?: zitadel_filter_v2beta_filter_pb.PaginationResponse.AsObject,
    executionsList: Array<zitadel_action_v2beta_execution_pb.Execution.AsObject>,
  }
}
