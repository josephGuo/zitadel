...
export class InConditionsFilter extends jspb.Message {
  getConditionsList(): Array<zitadel_action_v2beta_execution_pb.Condition>;
  setConditionsList(value: Array<zitadel_action_v2beta_execution_pb.Condition>): InConditionsFilter;
  clearConditionsList(): InConditionsFilter;
  addConditions(value?: zitadel_action_v2beta_execution_pb.Condition, index?: number): zitadel_action_v2beta_execution_pb.Condition;
...
export namespace InConditionsFilter {
  export type AsObject = {
    conditionsList: Array<zitadel_action_v2beta_execution_pb.Condition.AsObject>,
  }
}
...
export class TargetNameFilter extends jspb.Message {
  ...
  setMethod(value: zitadel_filter_v2beta_filter_pb.TextFilterMethod): TargetNameFilter;
