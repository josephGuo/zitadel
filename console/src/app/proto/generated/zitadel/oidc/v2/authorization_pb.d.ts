...
export class DeviceAuthorizationRequest extends jspb.Message {
  getId(): string;
  setId(value: string): DeviceAuthorizationRequest;

  getClientId(): string;
  setClientId(value: string): DeviceAuthorizationRequest;

  getScopeList(): Array<string>;
  setScopeList(value: Array<string>): DeviceAuthorizationRequest;
  clearScopeList(): DeviceAuthorizationRequest;
  addScope(value: string, index?: number): DeviceAuthorizationRequest;

  getAppName(): string;
  setAppName(value: string): DeviceAuthorizationRequest;

  getProjectName(): string;
  setProjectName(value: string): DeviceAuthorizationRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): DeviceAuthorizationRequest.AsObject;
  static toObject(includeInstance: boolean, msg: DeviceAuthorizationRequest): DeviceAuthorizationRequest.AsObject;
  static serializeBinaryToWriter(message: DeviceAuthorizationRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): DeviceAuthorizationRequest;
  static deserializeBinaryFromReader(message: DeviceAuthorizationRequest, reader: jspb.BinaryReader): DeviceAuthorizationRequest;
}
