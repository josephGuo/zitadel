...
export class OrgQuery extends jspb.Message {
  ...
  getIdQuery(): OrgIDQuery | undefined;
  setIdQuery(value?: OrgIDQuery): OrgQuery;
  hasIdQuery(): boolean;
  clearIdQuery(): OrgQuery;
...
export class OrgIDQuery extends jspb.Message {
  getId(): string;
  setId(value: string): OrgIDQuery;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): OrgIDQuery.AsObject;
  static toObject(includeInstance: boolean, msg: OrgIDQuery): OrgIDQuery.AsObject;
  static serializeBinaryToWriter(message: OrgIDQuery, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): OrgIDQuery;
  static deserializeBinaryFromReader(message: OrgIDQuery, reader: jspb.BinaryReader): OrgIDQuery;
}

export namespace OrgIDQuery {
  export type AsObject = {
    id: string,
  }
}
