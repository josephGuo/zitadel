...
export class ImportHumanUserRequest extends jspb.Message {
  ...
  getRecoveryCodesList(): Array<ImportHumanUserRequest.RecoveryCode>;
  setRecoveryCodesList(value: Array<ImportHumanUserRequest.RecoveryCode>): ImportHumanUserRequest;
  clearRecoveryCodesList(): ImportHumanUserRequest;
  addRecoveryCodes(value?: ImportHumanUserRequest.RecoveryCode, index?: number): ImportHumanUserRequest.RecoveryCode;
...
export namespace ImportHumanUserRequest {
  export type AsObject = {
    ...
    recoveryCodesList: Array<ImportHumanUserRequest.RecoveryCode.AsObject>,
  }
  ...
  export class RecoveryCode extends jspb.Message {
    getRaw(): string;
    setRaw(value: string): RecoveryCode;

    getHash(): string;
    setHash(value: string): RecoveryCode;

    getCodeTypeCase(): RecoveryCode.CodeTypeCase;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): RecoveryCode.AsObject;
    static toObject(includeInstance: boolean, msg: RecoveryCode): RecoveryCode.AsObject;
    static serializeBinaryToWriter(message: RecoveryCode, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): RecoveryCode;
    static deserializeBinaryFromReader(message: RecoveryCode, reader: jspb.BinaryReader): RecoveryCode;
  }

  export namespace RecoveryCode {
    export type AsObject = {
      raw: string,
      hash: string,
    }
...
export class AddMachineUserRequest extends jspb.Message {
  ...
  getUserId(): string;
  setUserId(value: string): AddMachineUserRequest;
  hasUserId(): boolean;
  clearUserId(): AddMachineUserRequest;
...
export class AddOIDCAppRequest extends jspb.Message {
  ...
  setBackChannelLogoutUri(value: string): AddOIDCAppRequest;

  getLoginVersion(): zitadel_app_pb.LoginVersion | undefined;
  setLoginVersion(value?: zitadel_app_pb.LoginVersion): AddOIDCAppRequest;
  hasLoginVersion(): boolean;
  clearLoginVersion(): AddOIDCAppRequest;
...
export namespace AddOIDCAppRequest {
  export type AsObject = {
    ...
    loginVersion?: zitadel_app_pb.LoginVersion.AsObject,
  }
}
...
export class AddSAMLAppRequest extends jspb.Message {
  ...
  getLoginVersion(): zitadel_app_pb.LoginVersion | undefined;
  setLoginVersion(value?: zitadel_app_pb.LoginVersion): AddSAMLAppRequest;
  hasLoginVersion(): boolean;
  clearLoginVersion(): AddSAMLAppRequest;
...
export class UpdateOIDCAppConfigRequest extends jspb.Message {
  ...
  getBackChannelLogoutUri(): string;
  setBackChannelLogoutUri(value: string): UpdateOIDCAppConfigRequest;

  getLoginVersion(): zitadel_app_pb.LoginVersion | undefined;
  setLoginVersion(value?: zitadel_app_pb.LoginVersion): UpdateOIDCAppConfigRequest;
  hasLoginVersion(): boolean;
  clearLoginVersion(): UpdateOIDCAppConfigRequest;
...
export class UpdateSAMLAppConfigRequest extends jspb.Message {
  ...
  getLoginVersion(): zitadel_app_pb.LoginVersion | undefined;
  setLoginVersion(value?: zitadel_app_pb.LoginVersion): UpdateSAMLAppConfigRequest;
  hasLoginVersion(): boolean;
  clearLoginVersion(): UpdateSAMLAppConfigRequest;
...
export class SetCustomInviteUserMessageTextRequest extends jspb.Message {
  getLanguage(): string;
  setLanguage(value: string): SetCustomInviteUserMessageTextRequest;

  getTitle(): string;
  setTitle(value: string): SetCustomInviteUserMessageTextRequest;

  getPreHeader(): string;
  setPreHeader(value: string): SetCustomInviteUserMessageTextRequest;

  getSubject(): string;
  setSubject(value: string): SetCustomInviteUserMessageTextRequest;

  getGreeting(): string;
  setGreeting(value: string): SetCustomInviteUserMessageTextRequest;

  getText(): string;
  setText(value: string): SetCustomInviteUserMessageTextRequest;

  getButtonText(): string;
  setButtonText(value: string): SetCustomInviteUserMessageTextRequest;

  getFooterText(): string;
  setFooterText(value: string): SetCustomInviteUserMessageTextRequest;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SetCustomInviteUserMessageTextRequest.AsObject;
  static toObject(includeInstance: boolean, msg: SetCustomInviteUserMessageTextRequest): SetCustomInviteUserMessageTextRequest.AsObject;
  static serializeBinaryToWriter(message: SetCustomInviteUserMessageTextRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SetCustomInviteUserMessageTextRequest;
  static deserializeBinaryFromReader(message: SetCustomInviteUserMessageTextRequest, reader: jspb.BinaryReader): SetCustomInviteUserMessageTextRequest;
}

export namespace SetCustomInviteUserMessageTextRequest {
  export type AsObject = {
    language: string,
    title: string,
    preHeader: string,
...
export class SetCustomInviteUserMessageTextResponse extends jspb.Message {
  getDetails(): zitadel_object_pb.ObjectDetails | undefined;
  setDetails(value?: zitadel_object_pb.ObjectDetails): SetCustomInviteUserMessageTextResponse;
  hasDetails(): boolean;
  clearDetails(): SetCustomInviteUserMessageTextResponse;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SetCustomInviteUserMessageTextResponse.AsObject;
  static toObject(includeInstance: boolean, msg: SetCustomInviteUserMessageTextResponse): SetCustomInviteUserMessageTextResponse.AsObject;
  static serializeBinaryToWriter(message: SetCustomInviteUserMessageTextResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SetCustomInviteUserMessageTextResponse;
  static deserializeBinaryFromReader(message: SetCustomInviteUserMessageTextResponse, reader: jspb.BinaryReader): SetCustomInviteUserMessageTextResponse;
}

export namespace SetCustomInviteUserMessageTextResponse {
  export type AsObject = {
    details?: zitadel_object_pb.ObjectDetails.AsObject,
  }
}
