...
import * as zitadel_session_v2_challenge_pb from '../../../zitadel/session/v2/challenge_pb'; // proto import: "zitadel/session/v2/challenge.proto"
import * as zitadel_session_v2_session_pb from '../../../zitadel/session/v2/session_pb'; // proto import: "zitadel/session/v2/session.proto"
...
export class ListSessionsRequest extends jspb.Message {
  ...
  setQuery(value?: zitadel_object_v2_object_pb.ListQuery): ListSessionsRequest;
  hasQuery(): boolean;
  clearQuery(): ListSessionsRequest;

  getQueriesList(): Array<zitadel_session_v2_session_pb.SearchQuery>;
  setQueriesList(value: Array<zitadel_session_v2_session_pb.SearchQuery>): ListSessionsRequest;
  clearQueriesList(): ListSessionsRequest;
  addQueries(value?: zitadel_session_v2_session_pb.SearchQuery, index?: number): zitadel_session_v2_session_pb.SearchQuery;

  getSortingColumn(): zitadel_session_v2_session_pb.SessionFieldName;
  setSortingColumn(value: zitadel_session_v2_session_pb.SessionFieldName): ListSessionsRequest;
...
export namespace ListSessionsRequest {
  export type AsObject = {
    ...
    queriesList: Array<zitadel_session_v2_session_pb.SearchQuery.AsObject>,
    sortingColumn: zitadel_session_v2_session_pb.SessionFieldName,
  }
}

export class ListSessionsResponse extends jspb.Message {
  getDetails(): zitadel_object_v2_object_pb.ListDetails | undefined;
  setDetails(value?: zitadel_object_v2_object_pb.ListDetails): ListSessionsResponse;
  hasDetails(): boolean;
  clearDetails(): ListSessionsResponse;

  getSessionsList(): Array<zitadel_session_v2_session_pb.Session>;
  setSessionsList(value: Array<zitadel_session_v2_session_pb.Session>): ListSessionsResponse;
  clearSessionsList(): ListSessionsResponse;
  addSessions(value?: zitadel_session_v2_session_pb.Session, index?: number): zitadel_session_v2_session_pb.Session;
...
export namespace ListSessionsResponse {
  export type AsObject = {
    ...
    sessionsList: Array<zitadel_session_v2_session_pb.Session.AsObject>,
  }
}
...
export class GetSessionResponse extends jspb.Message {
  getSession(): zitadel_session_v2_session_pb.Session | undefined;
  setSession(value?: zitadel_session_v2_session_pb.Session): GetSessionResponse;
  hasSession(): boolean;
...
export namespace GetSessionResponse {
  export type AsObject = {
    session?: zitadel_session_v2_session_pb.Session.AsObject,
  }
}
...
export class CreateSessionRequest extends jspb.Message {
  ...
  getChallenges(): zitadel_session_v2_challenge_pb.RequestChallenges | undefined;
  setChallenges(value?: zitadel_session_v2_challenge_pb.RequestChallenges): CreateSessionRequest;
  hasChallenges(): boolean;
  clearChallenges(): CreateSessionRequest;

  getUserAgent(): zitadel_session_v2_session_pb.UserAgent | undefined;
  setUserAgent(value?: zitadel_session_v2_session_pb.UserAgent): CreateSessionRequest;
...
export namespace CreateSessionRequest {
  export type AsObject = {
    ...
    challenges?: zitadel_session_v2_challenge_pb.RequestChallenges.AsObject,
    userAgent?: zitadel_session_v2_session_pb.UserAgent.AsObject,
...
export class CreateSessionResponse extends jspb.Message {
  ...
  setDetails(value?: zitadel_object_v2_object_pb.Details): CreateSessionResponse;
  hasDetails(): boolean;
  ...
  getChallenges(): zitadel_session_v2_challenge_pb.Challenges | undefined;
  setChallenges(value?: zitadel_session_v2_challenge_pb.Challenges): CreateSessionResponse;
  hasChallenges(): boolean;
...
export namespace CreateSessionResponse {
  export type AsObject = {
    ...
    sessionId: string,
    sessionToken: string,
    challenges?: zitadel_session_v2_challenge_pb.Challenges.AsObject,
  }
}
...
export class SetSessionRequest extends jspb.Message {
  ...
  getChallenges(): zitadel_session_v2_challenge_pb.RequestChallenges | undefined;
  setChallenges(value?: zitadel_session_v2_challenge_pb.RequestChallenges): SetSessionRequest;
  hasChallenges(): boolean;
...
export class SetSessionResponse extends jspb.Message {
  getDetails(): zitadel_object_v2_object_pb.Details | undefined;
  setDetails(value?: zitadel_object_v2_object_pb.Details): SetSessionResponse;
  hasDetails(): boolean;
  ...
  getChallenges(): zitadel_session_v2_challenge_pb.Challenges | undefined;
  setChallenges(value?: zitadel_session_v2_challenge_pb.Challenges): SetSessionResponse;
  hasChallenges(): boolean;
...
export class DeleteSessionResponse extends jspb.Message {
  getDetails(): zitadel_object_v2_object_pb.Details | undefined;
  setDetails(value?: zitadel_object_v2_object_pb.Details): DeleteSessionResponse;
  hasDetails(): boolean;
...
export class Checks extends jspb.Message {
  ...
  getRecoveryCode(): CheckRecoveryCode | undefined;
  setRecoveryCode(value?: CheckRecoveryCode): Checks;
  hasRecoveryCode(): boolean;
  clearRecoveryCode(): Checks;
...
export namespace Checks {
  export type AsObject = {
    ...
    recoveryCode?: CheckRecoveryCode.AsObject,
  }
  ...
  export enum RecoveryCodeCase { 
    _RECOVERY_CODE_NOT_SET = 0,
    RECOVERY_CODE = 8,
  }
}
...
export class CheckRecoveryCode extends jspb.Message {
  getCode(): string;
  setCode(value: string): CheckRecoveryCode;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): CheckRecoveryCode.AsObject;
  static toObject(includeInstance: boolean, msg: CheckRecoveryCode): CheckRecoveryCode.AsObject;
  static serializeBinaryToWriter(message: CheckRecoveryCode, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): CheckRecoveryCode;
  static deserializeBinaryFromReader(message: CheckRecoveryCode, reader: jspb.BinaryReader): CheckRecoveryCode;
}
