...
export class Factors extends jspb.Message {
  ...
  getRecoveryCode(): RecoveryCodeFactor | undefined;
  setRecoveryCode(value?: RecoveryCodeFactor): Factors;
  hasRecoveryCode(): boolean;
  clearRecoveryCode(): Factors;
...
export namespace Factors {
  export type AsObject = {
    ...
    recoveryCode?: RecoveryCodeFactor.AsObject,
  }
}
...
export class RecoveryCodeFactor extends jspb.Message {
  getVerifiedAt(): google_protobuf_timestamp_pb.Timestamp | undefined;
  setVerifiedAt(value?: google_protobuf_timestamp_pb.Timestamp): RecoveryCodeFactor;
  hasVerifiedAt(): boolean;
  clearVerifiedAt(): RecoveryCodeFactor;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RecoveryCodeFactor.AsObject;
  static toObject(includeInstance: boolean, msg: RecoveryCodeFactor): RecoveryCodeFactor.AsObject;
  static serializeBinaryToWriter(message: RecoveryCodeFactor, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RecoveryCodeFactor;
  static deserializeBinaryFromReader(message: RecoveryCodeFactor, reader: jspb.BinaryReader): RecoveryCodeFactor;
}

export namespace RecoveryCodeFactor {
  export type AsObject = {
    verifiedAt?: google_protobuf_timestamp_pb.Timestamp.AsObject,
  }
}
...
export class SearchQuery extends jspb.Message {
  ...
  getCreatorQuery(): CreatorQuery | undefined;
  setCreatorQuery(value?: CreatorQuery): SearchQuery;
  hasCreatorQuery(): boolean;
  clearCreatorQuery(): SearchQuery;

  getUserAgentQuery(): UserAgentQuery | undefined;
  setUserAgentQuery(value?: UserAgentQuery): SearchQuery;
  hasUserAgentQuery(): boolean;
  clearUserAgentQuery(): SearchQuery;

  getExpirationDateQuery(): ExpirationDateQuery | undefined;
  setExpirationDateQuery(value?: ExpirationDateQuery): SearchQuery;
  hasExpirationDateQuery(): boolean;
  clearExpirationDateQuery(): SearchQuery;
...
export namespace SearchQuery {
  export type AsObject = {
    ...
    creatorQuery?: CreatorQuery.AsObject,
    userAgentQuery?: UserAgentQuery.AsObject,
    expirationDateQuery?: ExpirationDateQuery.AsObject,
  }
...
export class CreatorQuery extends jspb.Message {
  getId(): string;
  setId(value: string): CreatorQuery;
  hasId(): boolean;
  clearId(): CreatorQuery;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): CreatorQuery.AsObject;
  static toObject(includeInstance: boolean, msg: CreatorQuery): CreatorQuery.AsObject;
  static serializeBinaryToWriter(message: CreatorQuery, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): CreatorQuery;
  static deserializeBinaryFromReader(message: CreatorQuery, reader: jspb.BinaryReader): CreatorQuery;
}

export namespace CreatorQuery {
  export type AsObject = {
    id?: string,
  }
...
export class UserAgentQuery extends jspb.Message {
  getFingerprintId(): string;
  setFingerprintId(value: string): UserAgentQuery;
  hasFingerprintId(): boolean;
  clearFingerprintId(): UserAgentQuery;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): UserAgentQuery.AsObject;
  static toObject(includeInstance: boolean, msg: UserAgentQuery): UserAgentQuery.AsObject;
  static serializeBinaryToWriter(message: UserAgentQuery, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): UserAgentQuery;
  static deserializeBinaryFromReader(message: UserAgentQuery, reader: jspb.BinaryReader): UserAgentQuery;
}

export namespace UserAgentQuery {
  export type AsObject = {
...
export class ExpirationDateQuery extends jspb.Message {
  getExpirationDate(): google_protobuf_timestamp_pb.Timestamp | undefined;
  setExpirationDate(value?: google_protobuf_timestamp_pb.Timestamp): ExpirationDateQuery;
  hasExpirationDate(): boolean;
  clearExpirationDate(): ExpirationDateQuery;

  getMethod(): zitadel_object_pb.TimestampQueryMethod;
  setMethod(value: zitadel_object_pb.TimestampQueryMethod): ExpirationDateQuery;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ExpirationDateQuery.AsObject;
  static toObject(includeInstance: boolean, msg: ExpirationDateQuery): ExpirationDateQuery.AsObject;
  static serializeBinaryToWriter(message: ExpirationDateQuery, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ExpirationDateQuery;
  static deserializeBinaryFromReader(message: ExpirationDateQuery, reader: jspb.BinaryReader): ExpirationDateQuery;
}

export namespace ExpirationDateQuery {
  export type AsObject = {
    expirationDate?: google_protobuf_timestamp_pb.Timestamp.AsObject,
    method: zitadel_object_pb.TimestampQueryMethod,
  }
