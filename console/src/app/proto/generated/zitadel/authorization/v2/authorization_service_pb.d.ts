...
import * as zitadel_authorization_v2_authorization_pb from '../../../zitadel/authorization/v2/authorization_pb'; // proto import: "zitadel/authorization/v2/authorization.proto"
...
export class ListAuthorizationsRequest extends jspb.Message {
  ...
  setPagination(value?: zitadel_filter_v2_filter_pb.PaginationRequest): ListAuthorizationsRequest;
  hasPagination(): boolean;
  clearPagination(): ListAuthorizationsRequest;

  getSortingColumn(): zitadel_authorization_v2_authorization_pb.AuthorizationFieldName;
  setSortingColumn(value: zitadel_authorization_v2_authorization_pb.AuthorizationFieldName): ListAuthorizationsRequest;

  getFiltersList(): Array<zitadel_authorization_v2_authorization_pb.AuthorizationsSearchFilter>;
  setFiltersList(value: Array<zitadel_authorization_v2_authorization_pb.AuthorizationsSearchFilter>): ListAuthorizationsRequest;
  clearFiltersList(): ListAuthorizationsRequest;
  addFilters(value?: zitadel_authorization_v2_authorization_pb.AuthorizationsSearchFilter, index?: number): zitadel_authorization_v2_authorization_pb.AuthorizationsSearchFilter;
...
export namespace ListAuthorizationsRequest {
  export type AsObject = {
    ...
    sortingColumn: zitadel_authorization_v2_authorization_pb.AuthorizationFieldName,
    filtersList: Array<zitadel_authorization_v2_authorization_pb.AuthorizationsSearchFilter.AsObject>,
  }
...
export class ListAuthorizationsResponse extends jspb.Message {
  ...
  setPagination(value?: zitadel_filter_v2_filter_pb.PaginationResponse): ListAuthorizationsResponse;
  hasPagination(): boolean;
  clearPagination(): ListAuthorizationsResponse;

  getAuthorizationsList(): Array<zitadel_authorization_v2_authorization_pb.Authorization>;
  setAuthorizationsList(value: Array<zitadel_authorization_v2_authorization_pb.Authorization>): ListAuthorizationsResponse;
  clearAuthorizationsList(): ListAuthorizationsResponse;
  addAuthorizations(value?: zitadel_authorization_v2_authorization_pb.Authorization, index?: number): zitadel_authorization_v2_authorization_pb.Authorization;
...
export namespace ListAuthorizationsResponse {
  export type AsObject = {
    ...
    authorizationsList: Array<zitadel_authorization_v2_authorization_pb.Authorization.AsObject>,
  }
}
