...
import * as zitadel_webkey_v2beta_key_pb from '../../../zitadel/webkey/v2beta/key_pb'; // proto import: "zitadel/webkey/v2beta/key.proto"


export class CreateWebKeyRequest extends jspb.Message {
  getRsa(): zitadel_webkey_v2beta_key_pb.RSA | undefined;
  setRsa(value?: zitadel_webkey_v2beta_key_pb.RSA): CreateWebKeyRequest;
  hasRsa(): boolean;
  clearRsa(): CreateWebKeyRequest;

  getEcdsa(): zitadel_webkey_v2beta_key_pb.ECDSA | undefined;
  setEcdsa(value?: zitadel_webkey_v2beta_key_pb.ECDSA): CreateWebKeyRequest;
  hasEcdsa(): boolean;
  clearEcdsa(): CreateWebKeyRequest;

  getEd25519(): zitadel_webkey_v2beta_key_pb.ED25519 | undefined;
  setEd25519(value?: zitadel_webkey_v2beta_key_pb.ED25519): CreateWebKeyRequest;
  hasEd25519(): boolean;
...
export namespace CreateWebKeyRequest {
  export type AsObject = {
    rsa?: zitadel_webkey_v2beta_key_pb.RSA.AsObject,
    ecdsa?: zitadel_webkey_v2beta_key_pb.ECDSA.AsObject,
    ed25519?: zitadel_webkey_v2beta_key_pb.ED25519.AsObject,
  }
...
export class ListWebKeysResponse extends jspb.Message {
  getWebKeysList(): Array<zitadel_webkey_v2beta_key_pb.WebKey>;
  setWebKeysList(value: Array<zitadel_webkey_v2beta_key_pb.WebKey>): ListWebKeysResponse;
  clearWebKeysList(): ListWebKeysResponse;
  addWebKeys(value?: zitadel_webkey_v2beta_key_pb.WebKey, index?: number): zitadel_webkey_v2beta_key_pb.WebKey;
...
export namespace ListWebKeysResponse {
  export type AsObject = {
    webKeysList: Array<zitadel_webkey_v2beta_key_pb.WebKey.AsObject>,
  }
}
