...
export class ManagementServiceClient {
  ...
  methodDescriptorGetCustomInviteUserMessageText = new grpcWeb.MethodDescriptor(
    ...
    grpcWeb.MethodType.UNARY,
    zitadel_management_pb.GetCustomInviteUserMessageTextRequest,
    zitadel_management_pb.GetCustomInviteUserMessageTextResponse,
    (request: zitadel_management_pb.GetCustomInviteUserMessageTextRequest) => {
      return request.serializeBinary();
    },
    zitadel_management_pb.GetCustomInviteUserMessageTextResponse.deserializeBinary
  );

  getCustomInviteUserMessageText(
    request: zitadel_management_pb.GetCustomInviteUserMessageTextRequest,
    metadata?: grpcWeb.Metadata | null): Promise<zitadel_management_pb.GetCustomInviteUserMessageTextResponse>;

  getCustomInviteUserMessageText(
    request: zitadel_management_pb.GetCustomInviteUserMessageTextRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: zitadel_management_pb.GetCustomInviteUserMessageTextResponse) => void): grpcWeb.ClientReadableStream<zitadel_management_pb.GetCustomInviteUserMessageTextResponse>;

  getCustomInviteUserMessageText(
    request: zitadel_management_pb.GetCustomInviteUserMessageTextRequest,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: zitadel_management_pb.GetCustomInviteUserMessageTextResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/zitadel.management.v1.ManagementService/GetCustomInviteUserMessageText',
  ...
  methodDescriptorGetDefaultInviteUserMessageText = new grpcWeb.MethodDescriptor(
    ...
    grpcWeb.MethodType.UNARY,
    zitadel_management_pb.GetDefaultInviteUserMessageTextRequest,
    zitadel_management_pb.GetDefaultInviteUserMessageTextResponse,
    (request: zitadel_management_pb.GetDefaultInviteUserMessageTextRequest) => {
      return request.serializeBinary();
    },
    zitadel_management_pb.GetDefaultInviteUserMessageTextResponse.deserializeBinary
  );

  getDefaultInviteUserMessageText(
    request: zitadel_management_pb.GetDefaultInviteUserMessageTextRequest,
    metadata?: grpcWeb.Metadata | null): Promise<zitadel_management_pb.GetDefaultInviteUserMessageTextResponse>;

  getDefaultInviteUserMessageText(
    request: zitadel_management_pb.GetDefaultInviteUserMessageTextRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: zitadel_management_pb.GetDefaultInviteUserMessageTextResponse) => void): grpcWeb.ClientReadableStream<zitadel_management_pb.GetDefaultInviteUserMessageTextResponse>;

  getDefaultInviteUserMessageText(
    request: zitadel_management_pb.GetDefaultInviteUserMessageTextRequest,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: zitadel_management_pb.GetDefaultInviteUserMessageTextResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/zitadel.management.v1.ManagementService/GetDefaultInviteUserMessageText',
  ...
  methodDescriptorSetCustomInviteUserMessageCustomText = new grpcWeb.MethodDescriptor(
    '/zitadel.management.v1.ManagementService/SetCustomInviteUserMessageCustomText',
    grpcWeb.MethodType.UNARY,
    zitadel_management_pb.SetCustomInviteUserMessageTextRequest,
    zitadel_management_pb.SetCustomInviteUserMessageTextResponse,
    (request: zitadel_management_pb.SetCustomInviteUserMessageTextRequest) => {
      return request.serializeBinary();
    },
    zitadel_management_pb.SetCustomInviteUserMessageTextResponse.deserializeBinary
  );

  setCustomInviteUserMessageCustomText(
    request: zitadel_management_pb.SetCustomInviteUserMessageTextRequest,
    metadata?: grpcWeb.Metadata | null): Promise<zitadel_management_pb.SetCustomInviteUserMessageTextResponse>;

  setCustomInviteUserMessageCustomText(
    request: zitadel_management_pb.SetCustomInviteUserMessageTextRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: zitadel_management_pb.SetCustomInviteUserMessageTextResponse) => void): grpcWeb.ClientReadableStream<zitadel_management_pb.SetCustomInviteUserMessageTextResponse>;

  setCustomInviteUserMessageCustomText(
    request: zitadel_management_pb.SetCustomInviteUserMessageTextRequest,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: zitadel_management_pb.SetCustomInviteUserMessageTextResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/zitadel.management.v1.ManagementService/SetCustomInviteUserMessageCustomText',
        request,
        metadata || {},
        this.methodDescriptorSetCustomInviteUserMessageCustomText,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
  ...
  methodDescriptorResetCustomInviteUserMessageTextToDefault = new grpcWeb.MethodDescriptor(
    ...
    grpcWeb.MethodType.UNARY,
    zitadel_management_pb.ResetCustomInviteUserMessageTextToDefaultRequest,
    zitadel_management_pb.ResetCustomInviteUserMessageTextToDefaultResponse,
    (request: zitadel_management_pb.ResetCustomInviteUserMessageTextToDefaultRequest) => {
      return request.serializeBinary();
    },
    zitadel_management_pb.ResetCustomInviteUserMessageTextToDefaultResponse.deserializeBinary
  );

  resetCustomInviteUserMessageTextToDefault(
    request: zitadel_management_pb.ResetCustomInviteUserMessageTextToDefaultRequest,
    metadata?: grpcWeb.Metadata | null): Promise<zitadel_management_pb.ResetCustomInviteUserMessageTextToDefaultResponse>;

  resetCustomInviteUserMessageTextToDefault(
    request: zitadel_management_pb.ResetCustomInviteUserMessageTextToDefaultRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: zitadel_management_pb.ResetCustomInviteUserMessageTextToDefaultResponse) => void): grpcWeb.ClientReadableStream<zitadel_management_pb.ResetCustomInviteUserMessageTextToDefaultResponse>;

  resetCustomInviteUserMessageTextToDefault(
    request: zitadel_management_pb.ResetCustomInviteUserMessageTextToDefaultRequest,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: zitadel_management_pb.ResetCustomInviteUserMessageTextToDefaultResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/zitadel.management.v1.ManagementService/ResetCustomInviteUserMessageTextToDefault',
