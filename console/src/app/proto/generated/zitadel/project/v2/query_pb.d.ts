...
export class ProjectSearchFilter extends jspb.Message {
  ...
  getInProjectIdsFilter(): zitadel_filter_v2_filter_pb.InIDsFilter | undefined;
  setInProjectIdsFilter(value?: zitadel_filter_v2_filter_pb.InIDsFilter): ProjectSearchFilter;
  hasInProjectIdsFilter(): boolean;
  clearInProjectIdsFilter(): ProjectSearchFilter;

  getOrganizationIdFilter(): ProjectOrganizationIDFilter | undefined;
  setOrganizationIdFilter(value?: ProjectOrganizationIDFilter): ProjectSearchFilter;
  hasOrganizationIdFilter(): boolean;
  clearOrganizationIdFilter(): ProjectSearchFilter;
...
export namespace ProjectSearchFilter {
  export type AsObject = {
    ...
    inProjectIdsFilter?: zitadel_filter_v2_filter_pb.InIDsFilter.AsObject,
    organizationIdFilter?: ProjectOrganizationIDFilter.AsObject,
  }
...
export class ProjectNameFilter extends jspb.Message {
  ...
  setMethod(value: zitadel_filter_v2_filter_pb.TextFilterMethod): ProjectNameFilter;
...
export class ProjectOrganizationIDFilter extends jspb.Message {
  getOrganizationId(): string;
  setOrganizationId(value: string): ProjectOrganizationIDFilter;

  getType(): ProjectOrganizationIDFilter.Type;
  setType(value: ProjectOrganizationIDFilter.Type): ProjectOrganizationIDFilter;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ProjectOrganizationIDFilter.AsObject;
  static toObject(includeInstance: boolean, msg: ProjectOrganizationIDFilter): ProjectOrganizationIDFilter.AsObject;
  static serializeBinaryToWriter(message: ProjectOrganizationIDFilter, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ProjectOrganizationIDFilter;
  static deserializeBinaryFromReader(message: ProjectOrganizationIDFilter, reader: jspb.BinaryReader): ProjectOrganizationIDFilter;
}

export namespace ProjectOrganizationIDFilter {
  export type AsObject = {
    organizationId: string,
    type: ProjectOrganizationIDFilter.Type,
  }
...
export class ProjectGrantSearchFilter extends jspb.Message {
  ...
  getInProjectIdsFilter(): zitadel_filter_v2_filter_pb.InIDsFilter | undefined;
  setInProjectIdsFilter(value?: zitadel_filter_v2_filter_pb.InIDsFilter): ProjectGrantSearchFilter;
  hasInProjectIdsFilter(): boolean;
  clearInProjectIdsFilter(): ProjectGrantSearchFilter;

  getOrganizationIdFilter(): zitadel_filter_v2_filter_pb.IDFilter | undefined;
  setOrganizationIdFilter(value?: zitadel_filter_v2_filter_pb.IDFilter): ProjectGrantSearchFilter;
  hasOrganizationIdFilter(): boolean;
  clearOrganizationIdFilter(): ProjectGrantSearchFilter;

  getGrantedOrganizationIdFilter(): zitadel_filter_v2_filter_pb.IDFilter | undefined;
  setGrantedOrganizationIdFilter(value?: zitadel_filter_v2_filter_pb.IDFilter): ProjectGrantSearchFilter;
  hasGrantedOrganizationIdFilter(): boolean;
  clearGrantedOrganizationIdFilter(): ProjectGrantSearchFilter;
...
export namespace ProjectGrantSearchFilter {
  export type AsObject = {
    ...
    grantedOrganizationIdFilter?: zitadel_filter_v2_filter_pb.IDFilter.AsObject,
  }
...
export class ProjectRoleKeyFilter extends jspb.Message {
  ...
  getMethod(): zitadel_filter_v2_filter_pb.TextFilterMethod;
  setMethod(value: zitadel_filter_v2_filter_pb.TextFilterMethod): ProjectRoleKeyFilter;
...
export class ProjectRoleDisplayNameFilter extends jspb.Message {
  ...
  getMethod(): zitadel_filter_v2_filter_pb.TextFilterMethod;
  setMethod(value: zitadel_filter_v2_filter_pb.TextFilterMethod): ProjectRoleDisplayNameFilter;
