...
export class DataHumanUser extends jspb.Message {
  ...
  getState(): zitadel_user_pb.UserState;
  setState(value: zitadel_user_pb.UserState): DataHumanUser;
...
export namespace DataHumanUser {
  export type AsObject = {
    ...
    state: zitadel_user_pb.UserState,
  }
}
...
export class DataMachineUser extends jspb.Message {
  ...
  getState(): zitadel_user_pb.UserState;
  setState(value: zitadel_user_pb.UserState): DataMachineUser;
