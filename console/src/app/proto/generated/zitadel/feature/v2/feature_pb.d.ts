...
export class LoginV2FeatureFlag extends jspb.Message {
  getRequired(): boolean;
  setRequired(value: boolean): LoginV2FeatureFlag;

  getBaseUri(): string;
  setBaseUri(value: string): LoginV2FeatureFlag;
  hasBaseUri(): boolean;
  clearBaseUri(): LoginV2FeatureFlag;

  getSource(): Source;
  setSource(value: Source): LoginV2FeatureFlag;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): LoginV2FeatureFlag.AsObject;
  static toObject(includeInstance: boolean, msg: LoginV2FeatureFlag): LoginV2FeatureFlag.AsObject;
  static serializeBinaryToWriter(message: LoginV2FeatureFlag, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): LoginV2FeatureFlag;
  static deserializeBinaryFromReader(message: LoginV2FeatureFlag, reader: jspb.BinaryReader): LoginV2FeatureFlag;
}

export namespace LoginV2FeatureFlag {
  export type AsObject = {
    required: boolean,
    baseUri?: string,
    source: Source,
...
export class LoginV2 extends jspb.Message {
  getRequired(): boolean;
  setRequired(value: boolean): LoginV2;
