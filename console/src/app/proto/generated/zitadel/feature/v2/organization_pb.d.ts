...
export class SetOrganizationFeaturesResponse extends jspb.Message {
  ...
  setDetails(value?: zitadel_object_v2_object_pb.Details): SetOrganizationFeaturesResponse;
  hasDetails(): boolean;
...
export class ResetOrganizationFeaturesResponse extends jspb.Message {
  getDetails(): zitadel_object_v2_object_pb.Details | undefined;
  setDetails(value?: zitadel_object_v2_object_pb.Details): ResetOrganizationFeaturesResponse;
  hasDetails(): boolean;
...
export class GetOrganizationFeaturesResponse extends jspb.Message {
  getDetails(): zitadel_object_v2_object_pb.Details | undefined;
  setDetails(value?: zitadel_object_v2_object_pb.Details): GetOrganizationFeaturesResponse;
  hasDetails(): boolean;
