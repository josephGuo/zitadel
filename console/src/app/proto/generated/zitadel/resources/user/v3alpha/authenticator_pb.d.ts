...
export class StartWebAuthNRegistration extends jspb.Message {
  getDomain(): string;
  setDomain(value: string): StartWebAuthNRegistration;

  getAuthenticatorType(): WebAuthNAuthenticatorType;
  setAuthenticatorType(value: WebAuthNAuthenticatorType): StartWebAuthNRegistration;

  getCode(): AuthenticatorRegistrationCode | undefined;
  setCode(value?: AuthenticatorRegistrationCode): StartWebAuthNRegistration;
  hasCode(): boolean;
  clearCode(): StartWebAuthNRegistration;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): StartWebAuthNRegistration.AsObject;
  static toObject(includeInstance: boolean, msg: StartWebAuthNRegistration): StartWebAuthNRegistration.AsObject;
  static serializeBinaryToWriter(message: StartWebAuthNRegistration, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): StartWebAuthNRegistration;
  static deserializeBinaryFromReader(message: StartWebAuthNRegistration, reader: jspb.BinaryReader): StartWebAuthNRegistration;
}

export namespace StartWebAuthNRegistration {
  export type AsObject = {
    domain: string,
    authenticatorType: WebAuthNAuthenticatorType,
    code?: AuthenticatorRegistrationCode.AsObject,
  }
...
export class VerifyWebAuthNRegistration extends jspb.Message {
  getPublicKeyCredential(): google_protobuf_struct_pb.Struct | undefined;
  setPublicKeyCredential(value?: google_protobuf_struct_pb.Struct): VerifyWebAuthNRegistration;
  hasPublicKeyCredential(): boolean;
  clearPublicKeyCredential(): VerifyWebAuthNRegistration;

  getWebAuthNName(): string;
  setWebAuthNName(value: string): VerifyWebAuthNRegistration;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): VerifyWebAuthNRegistration.AsObject;
  static toObject(includeInstance: boolean, msg: VerifyWebAuthNRegistration): VerifyWebAuthNRegistration.AsObject;
  static serializeBinaryToWriter(message: VerifyWebAuthNRegistration, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): VerifyWebAuthNRegistration;
  static deserializeBinaryFromReader(message: VerifyWebAuthNRegistration, reader: jspb.BinaryReader): VerifyWebAuthNRegistration;
}

export namespace VerifyWebAuthNRegistration {
  export type AsObject = {
...
export class AuthenticationKey extends jspb.Message {
  ...
  setDetails(value?: zitadel_resources_object_v3alpha_object_pb.Details): AuthenticationKey;
  hasDetails(): boolean;
