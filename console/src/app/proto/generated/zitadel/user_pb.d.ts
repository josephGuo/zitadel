...
export class UserGrantQuery extends jspb.Message {
  ...
  getInUserIdsQuery(): UserGrantInUserIDsQuery | undefined;
  setInUserIdsQuery(value?: UserGrantInUserIDsQuery): UserGrantQuery;
  hasInUserIdsQuery(): boolean;
  clearInUserIdsQuery(): UserGrantQuery;
...
export namespace UserGrantQuery {
  export type AsObject = {
    ...
    inUserIdsQuery?: UserGrantInUserIDsQuery.AsObject,
  }
...
export class UserGrantInUserIDsQuery extends jspb.Message {
  getInUserIdsList(): Array<string>;
  setInUserIdsList(value: Array<string>): UserGrantInUserIDsQuery;
  clearInUserIdsList(): UserGrantInUserIDsQuery;
  addInUserIds(value: string, index?: number): UserGrantInUserIDsQuery;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): UserGrantInUserIDsQuery.AsObject;
  static toObject(includeInstance: boolean, msg: UserGrantInUserIDsQuery): UserGrantInUserIDsQuery.AsObject;
  static serializeBinaryToWriter(message: UserGrantInUserIDsQuery, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): UserGrantInUserIDsQuery;
  static deserializeBinaryFromReader(message: UserGrantInUserIDsQuery, reader: jspb.BinaryReader): UserGrantInUserIDsQuery;
}

export namespace UserGrantInUserIDsQuery {
  export type AsObject = {
    inUserIdsList: Array<string>,
  }
}
