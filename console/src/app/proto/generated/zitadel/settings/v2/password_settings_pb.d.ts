...
export class PasswordComplexitySettings extends jspb.Message {
  ...
  setResourceOwnerType(value: zitadel_settings_v2_settings_pb.ResourceOwnerType): PasswordComplexitySettings;
...
export class PasswordExpirySettings extends jspb.Message {
  ...
  getResourceOwnerType(): zitadel_settings_v2_settings_pb.ResourceOwnerType;
  setResourceOwnerType(value: zitadel_settings_v2_settings_pb.ResourceOwnerType): PasswordExpirySettings;
