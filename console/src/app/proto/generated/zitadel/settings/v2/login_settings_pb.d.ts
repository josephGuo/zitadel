...
export class LoginSettings extends jspb.Message {
  ...
  getAllowLocalAuthentication(): boolean;
  setAllowLocalAuthentication(value: boolean): LoginSettings;
  ...
  getResourceOwnerType(): zitadel_settings_v2_settings_pb.ResourceOwnerType;
  setResourceOwnerType(value: zitadel_settings_v2_settings_pb.ResourceOwnerType): LoginSettings;
...
export namespace LoginSettings {
  export type AsObject = {
    ...
    resourceOwnerType: zitadel_settings_v2_settings_pb.ResourceOwnerType,
...
export class IdentityProvider extends jspb.Message {
  ...
  getOptions(): zitadel_idp_v2_idp_pb.Options | undefined;
  setOptions(value?: zitadel_idp_v2_idp_pb.Options): IdentityProvider;
  hasOptions(): boolean;
  clearOptions(): IdentityProvider;
...
export namespace IdentityProvider {
  export type AsObject = {
    ...
    options?: zitadel_idp_v2_idp_pb.Options.AsObject,
  }
}
