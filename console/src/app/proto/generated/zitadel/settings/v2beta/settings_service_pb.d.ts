...
import * as zitadel_settings_v2beta_organization_settings_pb from '../../../zitadel/settings/v2beta/organization_settings_pb'; // proto import: "zitadel/settings/v2beta/organization_settings.proto"
...
export class ListOrganizationSettingsRequest extends jspb.Message {
  ...
  setPagination(value?: zitadel_filter_v2beta_filter_pb.PaginationRequest): ListOrganizationSettingsRequest;
  hasPagination(): boolean;
  clearPagination(): ListOrganizationSettingsRequest;

  getSortingColumn(): zitadel_settings_v2beta_organization_settings_pb.OrganizationSettingsFieldName;
  setSortingColumn(value: zitadel_settings_v2beta_organization_settings_pb.OrganizationSettingsFieldName): ListOrganizationSettingsRequest;
  hasSortingColumn(): boolean;
  clearSortingColumn(): ListOrganizationSettingsRequest;

  getFiltersList(): Array<zitadel_settings_v2beta_organization_settings_pb.OrganizationSettingsSearchFilter>;
  setFiltersList(value: Array<zitadel_settings_v2beta_organization_settings_pb.OrganizationSettingsSearchFilter>): ListOrganizationSettingsRequest;
  clearFiltersList(): ListOrganizationSettingsRequest;
  addFilters(value?: zitadel_settings_v2beta_organization_settings_pb.OrganizationSettingsSearchFilter, index?: number): zitadel_settings_v2beta_organization_settings_pb.OrganizationSettingsSearchFilter;
...
export namespace ListOrganizationSettingsRequest {
  export type AsObject = {
    ...
    sortingColumn?: zitadel_settings_v2beta_organization_settings_pb.OrganizationSettingsFieldName,
    filtersList: Array<zitadel_settings_v2beta_organization_settings_pb.OrganizationSettingsSearchFilter.AsObject>,
  }
...
export class ListOrganizationSettingsResponse extends jspb.Message {
  ...
  setPagination(value?: zitadel_filter_v2beta_filter_pb.PaginationResponse): ListOrganizationSettingsResponse;
  hasPagination(): boolean;
  clearPagination(): ListOrganizationSettingsResponse;

  getOrganizationSettingsList(): Array<zitadel_settings_v2beta_organization_settings_pb.OrganizationSettings>;
  setOrganizationSettingsList(value: Array<zitadel_settings_v2beta_organization_settings_pb.OrganizationSettings>): ListOrganizationSettingsResponse;
  clearOrganizationSettingsList(): ListOrganizationSettingsResponse;
  addOrganizationSettings(value?: zitadel_settings_v2beta_organization_settings_pb.OrganizationSettings, index?: number): zitadel_settings_v2beta_organization_settings_pb.OrganizationSettings;
...
export namespace ListOrganizationSettingsResponse {
  export type AsObject = {
    ...
    organizationSettingsList: Array<zitadel_settings_v2beta_organization_settings_pb.OrganizationSettings.AsObject>,
  }
}
