...
.sub[_ngcontent-%COMP%] {
  ...
  font-size: 14px;
}`]});let t=o;return t})();var ji=[{path:"",component:tn,data:{animation:"HomePage"}},{path:"create",loadChildren:()=>import("./chunk-RXYNUKJH.js"),canActivate:[Bt],data:{animation:"AddPage",roles:["project.create"]}},{path:"app-create",canActivate:[Bt],data:{animation:"AddPage",roles:["project.app.write"]},loadChildren:()=>import("./chunk-SKBE2RSZ.js")},{path:":projectid",loadChildren:()=>import("./chunk-CHR7D3FX.js")}],en=(()=>{let o=class o{};o.\u0275fac=function(n){return new(n||o)},o.\u0275mod=Y({type:o}),o.\u0275inj=z({imports:[at.forChild(ji),at]});let t=o;return t})();var ar=(()=>{let o=class o{};o.\u0275fac=function(n){return new(n||o)},o.\u0275mod=Y({type:o}),o.\u0275inj=z({imports:[_t,en,Et,ee,fe,we,Ae,St,ft,ut,ge,Mt,$e,re,ze,Re,Je,he,Pe,Ce,ue,Le,Xt,Be]});let t=o;return t})();export{ar as default};
