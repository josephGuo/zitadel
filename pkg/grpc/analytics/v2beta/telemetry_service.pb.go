...
const file_zitadel_analytics_v2beta_telemetry_service_proto_rawDesc = "" +
	"\n" +
	"0zitadel/analytics/v2beta/telemetry_service.proto\x12\x18zitadel.analytics.v2beta\x1a\x1fgoogle/protobuf/timestamp.proto\x1a(zitadel/analytics/v2beta/telemetry.proto\"\xa2\x01\n" +
	"\x1cReportBaseInformationRequest\x12\x1b\n" +
	"\tsystem_id\x18\x01 \x01(\tR\bsystemId\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12K\n" +
	"\tinstances\x18\x03 \x03(\v2-.zitadel.analytics.v2beta.InstanceInformationR\tinstances\"<\n" +
	"\x1dReportBaseInformationResponse\x12\x1b\n" +
	"\treport_id\x18\x01 \x01(\tR\breportId\"\xbc\x01\n" +
	"\x1bReportResourceCountsRequest\x12\x1b\n" +
	"\tsystem_id\x18\x01 \x01(\tR\bsystemId\x12 \n" +
	"\treport_id\x18\x02 \x01(\tH\x00R\breportId\x88\x01\x01\x12P\n" +
	"\x0fresource_counts\x18\x03 \x03(\v2'.zitadel.analytics.v2beta.ResourceCountR\x0eresourceCountsB\f\n" +
	"\n" +
	"_report_id\";\n" +
	"\x1cReportResourceCountsResponse\x12\x1b\n" +
	"\treport_id\x18\x01 \x01(\tR\breportId2\xa9\x02\n" +
	"\x10TelemetryService\x12\x8a\x01\n" +
	"\x15ReportBaseInformation\x126.zitadel.analytics.v2beta.ReportBaseInformationRequest\x1a7.zitadel.analytics.v2beta.ReportBaseInformationResponse\"\x00\x12\x87\x01\n" +
	"\x14ReportResourceCounts\x125.zitadel.analytics.v2beta.ReportResourceCountsRequest\x1a6.zitadel.analytics.v2beta.ReportResourceCountsResponse\"\x00B@Z>github.com/zitadel/zitadel/pkg/grpc/analytics/v2beta;analyticsb\x06proto3"

var (
	file_zitadel_analytics_v2beta_telemetry_service_proto_rawDescOnce sync.Once
	file_zitadel_analytics_v2beta_telemetry_service_proto_rawDescData []byte
)
...
func file_zitadel_analytics_v2beta_telemetry_service_proto_rawDescGZIP() []byte {
	file_zitadel_analytics_v2beta_telemetry_service_proto_rawDescOnce.Do(func() {
		file_zitadel_analytics_v2beta_telemetry_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_analytics_v2beta_telemetry_service_proto_rawDesc), len(file_zitadel_analytics_v2beta_telemetry_service_proto_rawDesc)))
	})
...
var file_zitadel_analytics_v2beta_telemetry_service_proto_goTypes = []any{
...
func file_zitadel_analytics_v2beta_telemetry_service_proto_init() {
	...
	file_zitadel_analytics_v2beta_telemetry_service_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_analytics_v2beta_telemetry_service_proto_rawDesc), len(file_zitadel_analytics_v2beta_telemetry_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
