...
const file_zitadel_project_v2_query_proto_rawDesc = "" +
	...
	"\x06method\x18\x02 \x01(\x0e2#.zitadel.filter.v2.TextFilterMethodB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"\x8c\x02\n" +
	"\x1bProjectOrganizationIDFilter\x12M\n" +
	"\x0forganization_id\x18\x01 \x01(\tB$\x92A\x15J\x13\"69629012906488334\"\xe2A\x01\x02\xfaB\x05r\x03\x18\xc8\x01R\x0eorganizationId\x12R\n" +
