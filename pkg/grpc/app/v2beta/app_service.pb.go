...
const file_zitadel_app_v2beta_app_service_proto_rawDesc = "" +
	...
	"\rclient_secret\x18\x02 \x01(\tB7\x92A42 generated secret for this configJ\x10\"gjoq34589uasgh\"R\fclientSecret\"\xca\x04\n" +
	"\x18UpdateApplicationRequest\x12)\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tprojectId\x126\n" +
	"\x02id\x18\x02 \x01(\tB&\x92A\x15J\r\"45984352431\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x02id\x12:\n" +
	...
	"\x10auth_method_type\x18\x01 \x01(\x0e2%.zitadel.app.v2beta.APIAuthMethodTypeB\b\xfaB\x05\x82\x01\x02\x10\x01R\x0eauthMethodType\"O\n" +
	"\x15GetApplicationRequest\x126\n" +
	"\x02id\x18\x01 \x01(\tB&\x92A\x15J\r\"45984352431\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x02id\"K\n" +
