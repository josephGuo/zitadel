...
const file_zitadel_webkey_v2_key_proto_rawDesc = "" +
	"\n" +
	"\x1bzitadel/webkey/v2/key.proto\x12\x11zitadel.webkey.v2\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"\xbf\x03\n" +
	"\x06WebKey\x12(\n" +
	...
	"changeDate\x12.\n" +
	"\x05state\x18\x04 \x01(\x0e2\x18.zitadel.webkey.v2.StateR\x05state\x12*\n" +
	"\x03rsa\x18\x05 \x01(\v2\x16.zitadel.webkey.v2.RSAH\x00R\x03rsa\x120\n" +
	"\x05ecdsa\x18\x06 \x01(\v2\x18.zitadel.webkey.v2.ECDSAH\x00R\x05ecdsa\x126\n" +
	"\aed25519\x18\a \x01(\v2\x1a.zitadel.webkey.v2.ED25519H\x00R\aed25519B\x05\n" +
	"\x03key\"\xab\x01\n" +
	"\x03RSA\x12L\n" +
	"\x04bits\x18\x01 \x01(\x0e2\x1a.zitadel.webkey.v2.RSABitsB\x1c\x92A\x0f:\rRSA_BITS_2048\xfaB\a\x82\x01\x04\x10\x01 \x00R\x04bits\x12V\n" +
	"\x06hasher\x18\x02 \x01(\x0e2\x1c.zitadel.webkey.v2.RSAHasherB \x92A\x13:\x11RSA_HASHER_SHA256\xfaB\a\x82\x01\x04\x10\x01 \x00R\x06hasher\"]\n" +
	"\x05ECDSA\x12T\n" +
	"\x05curve\x18\x01 \x01(\x0e2\x1d.zitadel.webkey.v2.ECDSACurveB\x1f\x92A\x12:\x10ECDSA_CURVE_P256\xfaB\a\x82\x01\x04\x10\x01 \x00R\x05curve\"\t\n" +
	"\aED25519*j\n" +
	"\x05State\x12\x15\n" +
	...
	"\x10ECDSA_CURVE_P512\x10\x03B6Z4github.com/zitadel/zitadel/pkg/grpc/webkey/v2;webkeyb\x06proto3"

var (
	file_zitadel_webkey_v2_key_proto_rawDescOnce sync.Once
	file_zitadel_webkey_v2_key_proto_rawDescData []byte
)

func file_zitadel_webkey_v2_key_proto_rawDescGZIP() []byte {
	file_zitadel_webkey_v2_key_proto_rawDescOnce.Do(func() {
		file_zitadel_webkey_v2_key_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_webkey_v2_key_proto_rawDesc), len(file_zitadel_webkey_v2_key_proto_rawDesc)))
	})
...
var file_zitadel_webkey_v2_key_proto_goTypes = []any{
...
func file_zitadel_webkey_v2_key_proto_init() {
	...
	file_zitadel_webkey_v2_key_proto_msgTypes[0].OneofWrappers = []any{
		(*WebKey_Rsa)(nil),
		(*WebKey_Ecdsa)(nil),
		(*WebKey_Ed25519)(nil),
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_webkey_v2_key_proto_rawDesc), len(file_zitadel_webkey_v2_key_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
