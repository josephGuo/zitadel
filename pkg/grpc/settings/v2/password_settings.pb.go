...
const file_zitadel_settings_v2_password_settings_proto_rawDesc = "" +
	"\n" +
	"+zitadel/settings/v2/password_settings.proto\x12\x13zitadel.settings.v2\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\"zitadel/settings/v2/settings.proto\"\xcd\x02\n" +
	"\x1aPasswordComplexitySettings\x12'\n" +
	"\n" +
	"min_length\x18\x01 \x01(\x04B\b\x92A\x05J\x03\"8\"R\tminLength\x12-\n" +
	...
	"\x0frequires_symbol\x18\x05 \x01(\bR\x0erequiresSymbol\x12V\n" +
	"\x13resource_owner_type\x18\x06 \x01(\x0e2&.zitadel.settings.v2.ResourceOwnerTypeR\x11resourceOwnerType\"\xd3\x01\n" +
	"\x16PasswordExpirySettings\x12,\n" +
	"\fmax_age_days\x18\x01 \x01(\x04B\n" +
	"\x92A\aJ\x05\"365\"R\n" +
	"maxAgeDays\x123\n" +
	"\x10expire_warn_days\x18\x02 \x01(\x04B\t\x92A\x06J\x04\"10\"R\x0eexpireWarnDays\x12V\n" +
	"\x13resource_owner_type\x18\x03 \x01(\x0e2&.zitadel.settings.v2.ResourceOwnerTypeR\x11resourceOwnerTypeB:Z8github.com/zitadel/zitadel/pkg/grpc/settings/v2;settingsb\x06proto3"

var (
	file_zitadel_settings_v2_password_settings_proto_rawDescOnce sync.Once
	file_zitadel_settings_v2_password_settings_proto_rawDescData []byte
)
...
func file_zitadel_settings_v2_password_settings_proto_rawDescGZIP() []byte {
	file_zitadel_settings_v2_password_settings_proto_rawDescOnce.Do(func() {
		file_zitadel_settings_v2_password_settings_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_settings_v2_password_settings_proto_rawDesc), len(file_zitadel_settings_v2_password_settings_proto_rawDesc)))
	})
...
var file_zitadel_settings_v2_password_settings_proto_goTypes = []any{
...
func file_zitadel_settings_v2_password_settings_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_settings_v2_password_settings_proto_rawDesc), len(file_zitadel_settings_v2_password_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
