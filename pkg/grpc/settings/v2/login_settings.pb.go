...
const file_zitadel_settings_v2_login_settings_proto_rawDesc = "" +
	...
	"\aoptions\x18\x04 \x01(\v2\x17.zitadel.idp.v2.OptionsR\aoptions*\xf8\x01\n" +
	...
	"\x1aSECOND_FACTOR_TYPE_OTP_SMS\x10\x04\x12%\n" +
	"!SECOND_FACTOR_TYPE_RECOVERY_CODES\x10\x05\x1a\x02\x10\x01*a\n" +
