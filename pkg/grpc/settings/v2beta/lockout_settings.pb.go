...
const file_zitadel_settings_v2beta_lockout_settings_proto_rawDesc = "" +
	"\n" +
	".zitadel/settings/v2beta/lockout_settings.proto\x12\x17zitadel.settings.v2beta\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a&zitadel/settings/v2beta/settings.proto\"\xe3\x05\n" +
	"\x0fLockoutSettings\x12\x89\x02\n" +
	"\x15max_password_attempts\x18\x01 \x01(\x04B\xd4\x01\x92A\xd0\x012\xc7\x01Maximum password check attempts before the account gets locked. Attempts are reset as soon as the password is entered correctly or the password is reset. If set to 0 the account will never be locked.J\x04\"10\"R\x13maxPasswordAttempts\x12\xbe\x01\n" +
	"\x13resource_owner_type\x18\x02 \x01(\x0e2*.zitadel.settings.v2beta.ResourceOwnerTypeBb\x92A_2]resource_owner_type returns if the settings is managed on the organization or on the instanceR\x11resourceOwnerType\x12\x82\x02\n" +
	"\x10max_otp_attempts\x18\x03 \x01(\x04B\xd7\x01\x92A\xd3\x012\xca\x01Maximum failed attempts for a single OTP type (TOTP, SMS, Email) before the account gets locked. Attempts are reset as soon as the OTP is entered correctly. If set to 0 the account will never be locked.J\x04\"10\"R\x0emaxOtpAttemptsB>Z<github.com/zitadel/zitadel/pkg/grpc/settings/v2beta;settingsb\x06proto3"

var (
	file_zitadel_settings_v2beta_lockout_settings_proto_rawDescOnce sync.Once
	file_zitadel_settings_v2beta_lockout_settings_proto_rawDescData []byte
)
...
func file_zitadel_settings_v2beta_lockout_settings_proto_rawDescGZIP() []byte {
	file_zitadel_settings_v2beta_lockout_settings_proto_rawDescOnce.Do(func() {
		file_zitadel_settings_v2beta_lockout_settings_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_settings_v2beta_lockout_settings_proto_rawDesc), len(file_zitadel_settings_v2beta_lockout_settings_proto_rawDesc)))
	})
...
var file_zitadel_settings_v2beta_lockout_settings_proto_goTypes = []any{
...
func file_zitadel_settings_v2beta_lockout_settings_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_settings_v2beta_lockout_settings_proto_rawDesc), len(file_zitadel_settings_v2beta_lockout_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
