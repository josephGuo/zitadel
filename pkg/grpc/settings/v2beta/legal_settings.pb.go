...
const file_zitadel_settings_v2beta_legal_settings_proto_rawDesc = "" +
	"\n" +
	",zitadel/settings/v2beta/legal_settings.proto\x12\x17zitadel.settings.v2beta\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a&zitadel/settings/v2beta/settings.proto\x1a\x17validate/validate.proto\"\x98\b\n" +
	...
	"\thelp_link\x18\x03 \x01(\tB7\x92A4J2\"https://zitadel.com/docs/manage/console-overview\"R\bhelpLink\x12n\n" +
...
var (
	...
	file_zitadel_settings_v2beta_legal_settings_proto_rawDescData []byte
)
...
func file_zitadel_settings_v2beta_legal_settings_proto_rawDescGZIP() []byte {
	file_zitadel_settings_v2beta_legal_settings_proto_rawDescOnce.Do(func() {
		file_zitadel_settings_v2beta_legal_settings_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_settings_v2beta_legal_settings_proto_rawDesc), len(file_zitadel_settings_v2beta_legal_settings_proto_rawDesc)))
	})
...
var file_zitadel_settings_v2beta_legal_settings_proto_goTypes = []any{
...
func file_zitadel_settings_v2beta_legal_settings_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_settings_v2beta_legal_settings_proto_rawDesc), len(file_zitadel_settings_v2beta_legal_settings_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
