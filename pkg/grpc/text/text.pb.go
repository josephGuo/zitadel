...
const file_zitadel_text_proto_rawDesc = "" +
	"\n" +
	"\x12zitadel/text.proto\x12\x0fzitadel.text.v1\x1a\x14zitadel/object.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"\xb9\x06\n" +
	"\x11MessageCustomText\x123\n" +
	"\adetails\x18\x01 \x01(\v2\x19.zitadel.v1.ObjectDetailsR\adetails\x12Q\n" +
	"\x05title\x18\x02 \x01(\tB;\x92A82\x1bcustom text for email titleJ\x19\"ZITADEL - Message Title\"R\x05title\x12T\n" +
	"\n" +
	"pre_header\x18\x03 \x01(\tB5\x92A22 custom text for email pre-headerJ\x0e\"User Message\"R\tpreHeader\x12O\n" +
	"\asubject\x18\x04 \x01(\tB5\x92A22\x1dcustom text for email subjectJ\x11\"Message Subject\"R\asubject\x12f\n" +
	"\bgreeting\x18\x05 \x01(\tBJ\x92AG2\x1ecustom text for email greetingJ%\"Hello {{.FirstName}} {{.LastName}},\"R\bgreeting\x12\xc5\x01\n" +
	"\x04text\x18\x06 \x01(\tB\xb0\x01\x92A\xac\x012\x1acustom text for email textJ\x8d\x01\"This is my custom message Text. I can also include some fields, depending on the message type I want to send. {{.FirstName}} {{.LastName}},\"R\x04text\x12Y\n" +
	"\vbutton_text\x18\a \x01(\tB8\x92A52!custom text for email button_textJ\x10\"Call to action\"R\n" +
	"buttonText\x12K\n" +
	"\vfooter_text\x18\b \x01(\tB*\x92A'2!custom text for email footer_textJ\x02\"\"R\n" +
	"footerText\x12\x1d\n" +
	"\n" +
	"is_default\x18\t \x01(\bR\tisDefault\"\x85\x1b\n" +
	"\x0fLoginCustomText\x123\n" +
	"\adetails\x18\x01 \x01(\v2\x19.zitadel.v1.ObjectDetailsR\adetails\x12X\n" +
	"\x13select_account_text\x18\x02 \x01(\v2(.zitadel.text.v1.SelectAccountScreenTextR\x11selectAccountText\x12?\n" +
	"\n" +
	"login_text\x18\x03 \x01(\v2 .zitadel.text.v1.LoginScreenTextR\tloginText\x12H\n" +
	"\rpassword_text\x18\x04 \x01(\v2#.zitadel.text.v1.PasswordScreenTextR\fpasswordText\x12[\n" +
	"\x14username_change_text\x18\x05 \x01(\v2).zitadel.text.v1.UsernameChangeScreenTextR\x12usernameChangeText\x12h\n" +
	"\x19username_change_done_text\x18\x06 \x01(\v2-.zitadel.text.v1.UsernameChangeDoneScreenTextR\x16usernameChangeDoneText\x12U\n" +
	"\x12init_password_text\x18\a \x01(\v2'.zitadel.text.v1.InitPasswordScreenTextR\x10initPasswordText\x12b\n" +
	"\x17init_password_done_text\x18\b \x01(\v2+.zitadel.text.v1.InitPasswordDoneScreenTextR\x14initPasswordDoneText\x12d\n" +
	"\x17email_verification_text\x18\t \x01(\v2,.zitadel.text.v1.EmailVerificationScreenTextR\x15emailVerificationText\x12q\n" +
	"\x1cemail_verification_done_text\x18\n" +
	" \x01(\v20.zitadel.text.v1.EmailVerificationDoneScreenTextR\x19emailVerificationDoneText\x12[\n" +
	"\x14initialize_user_text\x18\v \x01(\v2).zitadel.text.v1.InitializeUserScreenTextR\x12initializeUserText\x12_\n" +
	"\x14initialize_done_text\x18\f \x01(\v2-.zitadel.text.v1.InitializeUserDoneScreenTextR\x12initializeDoneText\x12Y\n" +
	"\x14init_mfa_prompt_text\x18\r \x01(\v2(.zitadel.text.v1.InitMFAPromptScreenTextR\x11initMfaPromptText\x12P\n" +
	"\x11init_mfa_otp_text\x18\x0e \x01(\v2%.zitadel.text.v1.InitMFAOTPScreenTextR\x0einitMfaOtpText\x12P\n" +
	"\x11init_mfa_u2f_text\x18\x0f \x01(\v2%.zitadel.text.v1.InitMFAU2FScreenTextR\x0einitMfaU2fText\x12S\n" +
	"\x12init_mfa_done_text\x18\x10 \x01(\v2&.zitadel.text.v1.InitMFADoneScreenTextR\x0finitMfaDoneText\x12O\n" +
	"\x12mfa_providers_text\x18\x11 \x01(\v2!.zitadel.text.v1.MFAProvidersTextR\x10mfaProvidersText\x12V\n" +
	"\x13verify_mfa_otp_text\x18\x12 \x01(\v2'.zitadel.text.v1.VerifyMFAOTPScreenTextR\x10verifyMfaOtpText\x12V\n" +
	"\x13verify_mfa_u2f_text\x18\x13 \x01(\v2'.zitadel.text.v1.VerifyMFAU2FScreenTextR\x10verifyMfaU2fText\x12T\n" +
	"\x11passwordless_text\x18\x14 \x01(\v2'.zitadel.text.v1.PasswordlessScreenTextR\x10passwordlessText\x12[\n" +
	"\x14password_change_text\x18\x15 \x01(\v2).zitadel.text.v1.PasswordChangeScreenTextR\x12passwordChangeText\x12h\n" +
	"\x19password_change_done_text\x18\x16 \x01(\v2-.zitadel.text.v1.PasswordChangeDoneScreenTextR\x16passwordChangeDoneText\x12e\n" +
	"\x18password_reset_done_text\x18\x17 \x01(\v2,.zitadel.text.v1.PasswordResetDoneScreenTextR\x15passwordResetDoneText\x12g\n" +
	"\x18registration_option_text\x18\x18 \x01(\v2-.zitadel.text.v1.RegistrationOptionScreenTextR\x16registrationOptionText\x12a\n" +
	"\x16registration_user_text\x18\x19 \x01(\v2+.zitadel.text.v1.RegistrationUserScreenTextR\x14registrationUserText\x12^\n" +
	"\x15registration_org_text\x18\x1a \x01(\v2*.zitadel.text.v1.RegistrationOrgScreenTextR\x13registrationOrgText\x12_\n" +
	"\x16linking_user_done_text\x18\x1b \x01(\v2*.zitadel.text.v1.LinkingUserDoneScreenTextR\x13linkingUserDoneText\x12o\n" +
	"\x1cexternal_user_not_found_text\x18\x1c \x01(\v2/.zitadel.text.v1.ExternalUserNotFoundScreenTextR\x18externalUserNotFoundText\x12U\n" +
	"\x12success_login_text\x18\x1d \x01(\v2'.zitadel.text.v1.SuccessLoginScreenTextR\x10successLoginText\x12F\n" +
	"\vlogout_text\x18\x1e \x01(\v2%.zitadel.text.v1.LogoutDoneScreenTextR\n" +
	"logoutText\x12<\n" +
	"\vfooter_text\x18\x1f \x01(\v2\x1b.zitadel.text.v1.FooterTextR\n" +
	"footerText\x12g\n" +
	"\x18passwordless_prompt_text\x18  \x01(\v2-.zitadel.text.v1.PasswordlessPromptScreenTextR\x16passwordlessPromptText\x12y\n" +
	"\x1epasswordless_registration_text\x18! \x01(\v23.zitadel.text.v1.PasswordlessRegistrationScreenTextR\x1cpasswordlessRegistrationText\x12\x86\x01\n" +
	"#passwordless_registration_done_text\x18\" \x01(\v27.zitadel.text.v1.PasswordlessRegistrationDoneScreenTextR passwordlessRegistrationDoneText\x12\x93\x01\n" +
	"(external_registration_user_overview_text\x18# \x01(\v2;.zitadel.text.v1.ExternalRegistrationUserOverviewScreenTextR$externalRegistrationUserOverviewText\x12\x1d\n" +
	"\n" +
	"is_default\x18$ \x01(\bR\tisDefault\x12i\n" +
	"\x18linking_user_prompt_text\x18% \x01(\v2,.zitadel.text.v1.LinkingUserPromptScreenTextB\x02\x18\x01R\x15linkingUserPromptText\"\xd5\x03\n" +
	"\x17SelectAccountScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12<\n" +
	"\x15title_linking_process\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x13titleLinkingProcess\x12H\n" +
	"\x1bdescription_linking_process\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x19descriptionLinkingProcess\x12'\n" +
	"\n" +
	"other_user\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\totherUser\x129\n" +
	"\x14session_state_active\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x18dR\x12sessionStateActive\x12=\n" +
	"\x16session_state_inactive\x18\a \x01(\tB\a\xfaB\x04r\x02\x18dR\x14sessionStateInactive\x12C\n" +
	"\x1auser_must_be_member_of_org\x18\b \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x15userMustBeMemberOfOrg\"\x90\x05\n" +
	"\x0fLoginScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12<\n" +
	"\x15title_linking_process\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x13titleLinkingProcess\x12H\n" +
	"\x1bdescription_linking_process\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x19descriptionLinkingProcess\x12C\n" +
	"\x1auser_must_be_member_of_org\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x15userMustBeMemberOfOrg\x122\n" +
	"\x10login_name_label\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0eloginNameLabel\x129\n" +
	"\x14register_button_text\x18\a \x01(\tB\a\xfaB\x04r\x02\x18dR\x12registerButtonText\x121\n" +
	"\x10next_button_text\x18\b \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\x12D\n" +
	"\x19external_user_description\x18\t \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x17externalUserDescription\x12<\n" +
	"\x15user_name_placeholder\x18\n" +
	" \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x13userNamePlaceholder\x12>\n" +
	"\x16login_name_placeholder\x18\v \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x14loginNamePlaceholder\"\xa9\x04\n" +
	"\x12PasswordScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12/\n" +
	"\x0epassword_label\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rpasswordLabel\x12/\n" +
	"\x0freset_link_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\rresetLinkText\x121\n" +
	"\x10back_button_text\x18\x05 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0ebackButtonText\x121\n" +
	"\x10next_button_text\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\x12&\n" +
	"\n" +
	"min_length\x18\a \x01(\tB\a\xfaB\x04r\x02\x18dR\tminLength\x12,\n" +
	"\rhas_uppercase\x18\b \x01(\tB\a\xfaB\x04r\x02\x18dR\fhasUppercase\x12,\n" +
	"\rhas_lowercase\x18\t \x01(\tB\a\xfaB\x04r\x02\x18dR\fhasLowercase\x12&\n" +
	"\n" +
	"has_number\x18\n" +
	" \x01(\tB\a\xfaB\x04r\x02\x18dR\thasNumber\x12&\n" +
	"\n" +
	"has_symbol\x18\v \x01(\tB\a\xfaB\x04r\x02\x18dR\thasSymbol\x12+\n" +
	"\fconfirmation\x18\f \x01(\tB\a\xfaB\x04r\x02\x18dR\fconfirmation\"\x81\x02\n" +
	"\x18UsernameChangeScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12/\n" +
	"\x0eusername_label\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rusernameLabel\x125\n" +
	"\x12cancel_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x10cancelButtonText\x121\n" +
	"\x10next_button_text\x18\x05 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\"\x9d\x01\n" +
	"\x1cUsernameChangeDoneScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x121\n" +
	"\x10next_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\"\xf6\x02\n" +
	"\x16InitPasswordScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12'\n" +
	"\n" +
	"code_label\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\tcodeLabel\x126\n" +
	"\x12new_password_label\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x10newPasswordLabel\x12E\n" +
	"\x1anew_password_confirm_label\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x17newPasswordConfirmLabel\x121\n" +
	"\x10next_button_text\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\x125\n" +
	"\x12resend_button_text\x18\a \x01(\tB\a\xfaB\x04r\x02\x18dR\x10resendButtonText\"\xd2\x01\n" +
	"\x1aInitPasswordDoneScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x121\n" +
	"\x10next_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\x125\n" +
	"\x12cancel_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x10cancelButtonText\"\xfc\x01\n" +
	"\x1bEmailVerificationScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12'\n" +
	"\n" +
	"code_label\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\tcodeLabel\x121\n" +
	"\x10next_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\x125\n" +
	"\x12resend_button_text\x18\x05 \x01(\tB\a\xfaB\x04r\x02\x18dR\x10resendButtonText\"\x8c\x02\n" +
	"\x1fEmailVerificationDoneScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x121\n" +
	"\x10next_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\x125\n" +
	"\x12cancel_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x10cancelButtonText\x123\n" +
	"\x11login_button_text\x18\x05 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0floginButtonText\"\xf8\x02\n" +
	"\x18InitializeUserScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12'\n" +
	"\n" +
	"code_label\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\tcodeLabel\x126\n" +
	"\x12new_password_label\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x10newPasswordLabel\x12E\n" +
	"\x1anew_password_confirm_label\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x17newPasswordConfirmLabel\x125\n" +
	"\x12resend_button_text\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x18dR\x10resendButtonText\x121\n" +
	"\x10next_button_text\x18\a \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\"\xd4\x01\n" +
	"\x1cInitializeUserDoneScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x125\n" +
	"\x12cancel_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x10cancelButtonText\x121\n" +
	"\x10next_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\"\x9d\x02\n" +
	"\x17InitMFAPromptScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12'\n" +
	"\n" +
	"otp_option\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\totpOption\x12'\n" +
	"\n" +
	"u2f_option\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\tu2fOption\x121\n" +
	"\x10skip_button_text\x18\x05 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0eskipButtonText\x121\n" +
	"\x10next_button_text\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\"\xd5\x02\n" +
	"\x14InitMFAOTPScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x121\n" +
	"\x0fdescription_otp\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x0edescriptionOtp\x12+\n" +
	"\fsecret_label\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\vsecretLabel\x12'\n" +
	"\n" +
	"code_label\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\tcodeLabel\x121\n" +
	"\x10next_button_text\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\x125\n" +
	"\x12cancel_button_text\x18\a \x01(\tB\a\xfaB\x04r\x02\x18dR\x10cancelButtonText\"\xb6\x02\n" +
	"\x14InitMFAU2FScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x122\n" +
	"\x10token_name_label\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0etokenNameLabel\x12-\n" +
	"\rnot_supported\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\fnotSupported\x12D\n" +
	"\x1aregister_token_button_text\x18\x05 \x01(\tB\a\xfaB\x04r\x02\x18dR\x17registerTokenButtonText\x12)\n" +
	"\verror_retry\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\n" +
	"errorRetry\"\xcd\x01\n" +
	"\x15InitMFADoneScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x125\n" +
	"\x12cancel_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x10cancelButtonText\x121\n" +
	"\x10next_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\"w\n" +
	"\x10MFAProvidersText\x12+\n" +
	"\fchoose_other\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vchooseOther\x12\x1a\n" +
	"\x03otp\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x03otp\x12\x1a\n" +
	"\x03u2f\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x03u2f\"\xc0\x01\n" +
	"\x16VerifyMFAOTPScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12'\n" +
	"\n" +
	"code_label\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\tcodeLabel\x121\n" +
	"\x10next_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\"\xf8\x01\n" +
	"\x16VerifyMFAU2FScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x128\n" +
	"\x13validate_token_text\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x11validateTokenText\x12-\n" +
	"\rnot_supported\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\fnotSupported\x12)\n" +
	"\verror_retry\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\n" +
	"errorRetry\"\xc8\x02\n" +
	"\x16PasswordlessScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12A\n" +
	"\x19login_with_pw_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x15loginWithPwButtonText\x12E\n" +
	"\x1avalidate_token_button_text\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x17validateTokenButtonText\x12-\n" +
	"\rnot_supported\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\fnotSupported\x12)\n" +
	"\verror_retry\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\n" +
	"errorRetry\"\xc2\x03\n" +
	"\x18PasswordChangeScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x126\n" +
	"\x12old_password_label\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x10oldPasswordLabel\x126\n" +
	"\x12new_password_label\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x10newPasswordLabel\x12E\n" +
	"\x1anew_password_confirm_label\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x17newPasswordConfirmLabel\x125\n" +
	"\x12cancel_button_text\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x18dR\x10cancelButtonText\x121\n" +
	"\x10next_button_text\x18\a \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\x129\n" +
	"\x13expired_description\x18\b \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x12expiredDescription\"\x9d\x01\n" +
	"\x1cPasswordChangeDoneScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x121\n" +
	"\x10next_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\"\x9c\x01\n" +
	"\x1bPasswordResetDoneScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x121\n" +
	"\x10next_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\"\xa5\x02\n" +
	"\x1cRegistrationOptionScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12;\n" +
	"\x15user_name_button_text\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x12userNameButtonText\x12F\n" +
	"\x1aexternal_login_description\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x18externalLoginDescription\x124\n" +
	"\x11login_button_text\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0floginButtonText\"\xff\a\n" +
	"\x1aRegistrationUserScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12B\n" +
	"\x18description_org_register\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x16descriptionOrgRegister\x121\n" +
	"\x0ffirstname_label\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0efirstnameLabel\x12/\n" +
	"\x0elastname_label\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rlastnameLabel\x12)\n" +
	"\vemail_label\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\n" +
	"emailLabel\x12/\n" +
	"\x0eusername_label\x18\a \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rusernameLabel\x12/\n" +
	"\x0elanguage_label\x18\b \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rlanguageLabel\x12+\n" +
	"\fgender_label\x18\t \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\vgenderLabel\x12/\n" +
	"\x0epassword_label\x18\n" +
	" \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rpasswordLabel\x12>\n" +
	"\x16password_confirm_label\x18\v \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x14passwordConfirmLabel\x12;\n" +
	"\x15tos_and_privacy_label\x18\f \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x12tosAndPrivacyLabel\x12)\n" +
	"\vtos_confirm\x18\r \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\n" +
	"tosConfirm\x12,\n" +
	"\rtos_link_text\x18\x0f \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\vtosLinkText\x121\n" +
	"\x0fprivacy_confirm\x18\x10 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0eprivacyConfirm\x124\n" +
	"\x11privacy_link_text\x18\x12 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0fprivacyLinkText\x122\n" +
	"\x10next_button_text\x18\x14 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0enextButtonText\x122\n" +
	"\x10back_button_text\x18\x15 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0ebackButtonTextJ\x04\b\x0e\x10\x0fJ\x04\b\x11\x10\x12J\x04\b\x13\x10\x14J\x04\b\x16\x10\x17R\btos_linkR\fprivacy_linkR\x1aexternal_login_descriptionR\x0ftos_confirm_and\"\xc3\x06\n" +
	"*ExternalRegistrationUserOverviewScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12)\n" +
	"\vemail_label\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\n" +
	"emailLabel\x12/\n" +
	"\x0eusername_label\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rusernameLabel\x121\n" +
	"\x0ffirstname_label\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0efirstnameLabel\x12/\n" +
	"\x0elastname_label\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rlastnameLabel\x12/\n" +
	"\x0enickname_label\x18\a \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rnicknameLabel\x12/\n" +
	"\x0elanguage_label\x18\b \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rlanguageLabel\x12)\n" +
	"\vphone_label\x18\t \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\n" +
	"phoneLabel\x12;\n" +
	"\x15tos_and_privacy_label\x18\n" +
	" \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x12tosAndPrivacyLabel\x12)\n" +
	"\vtos_confirm\x18\v \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\n" +
	"tosConfirm\x12,\n" +
	"\rtos_link_text\x18\f \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\vtosLinkText\x124\n" +
	"\x11privacy_link_text\x18\x0e \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0fprivacyLinkText\x122\n" +
	"\x10back_button_text\x18\x0f \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0ebackButtonText\x122\n" +
	"\x10next_button_text\x18\x10 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0enextButtonText\x121\n" +
	"\x0fprivacy_confirm\x18\x11 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0eprivacyConfirmJ\x04\b\r\x10\x0eR\x0ftos_confirm_and\"\xd7\x06\n" +
	"\x19RegistrationOrgScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x12-\n" +
	"\rorgname_label\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\forgnameLabel\x121\n" +
	"\x0ffirstname_label\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0efirstnameLabel\x12/\n" +
	"\x0elastname_label\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rlastnameLabel\x12/\n" +
	"\x0eusername_label\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rusernameLabel\x12)\n" +
	"\vemail_label\x18\a \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\n" +
	"emailLabel\x12/\n" +
	"\x0epassword_label\x18\t \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rpasswordLabel\x12>\n" +
	"\x16password_confirm_label\x18\n" +
	" \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x14passwordConfirmLabel\x12;\n" +
	"\x15tos_and_privacy_label\x18\v \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x12tosAndPrivacyLabel\x12)\n" +
	"\vtos_confirm\x18\f \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\n" +
	"tosConfirm\x12,\n" +
	"\rtos_link_text\x18\x0e \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\vtosLinkText\x121\n" +
	"\x0fprivacy_confirm\x18\x0f \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0eprivacyConfirm\x124\n" +
	"\x11privacy_link_text\x18\x11 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0fprivacyLinkText\x122\n" +
	"\x10save_button_text\x18\x13 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0esaveButtonTextJ\x04\b\r\x10\x0eJ\x04\b\x10\x10\x11J\x04\b\x12\x10\x13J\x04\b\x14\x10\x15R\btos_linkR\fprivacy_linkR\x1aexternal_login_descriptionR\x0ftos_confirm_and\"\xd1\x01\n" +
	"\x1bLinkingUserPromptScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x121\n" +
	"\x10link_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0elinkButtonText\x123\n" +
	"\x11other_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0fotherButtonText\"\xd1\x01\n" +
	"\x19LinkingUserDoneScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x125\n" +
	"\x12cancel_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x10cancelButtonText\x121\n" +
	"\x10next_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\"\xf9\x03\n" +
	"\x1eExternalUserNotFoundScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x121\n" +
	"\x10link_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0elinkButtonText\x12B\n" +
	"\x19auto_register_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x16autoRegisterButtonText\x12;\n" +
	"\x15tos_and_privacy_label\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x12tosAndPrivacyLabel\x12)\n" +
	"\vtos_confirm\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\n" +
	"tosConfirm\x12,\n" +
	"\rtos_link_text\x18\a \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\vtosLinkText\x124\n" +
	"\x11privacy_link_text\x18\b \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0fprivacyLinkText\x121\n" +
	"\x0fprivacy_confirm\x18\n" +
	" \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0eprivacyConfirmJ\x04\b\t\x10\n" +
	"R\x0ftos_confirm_and\"\xf2\x01\n" +
	"\x16SuccessLoginScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12D\n" +
	"\x19auto_redirect_description\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x17autoRedirectDescription\x12>\n" +
	"\x16redirected_description\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x15redirectedDescription\x122\n" +
	"\x10next_button_text\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0enextButtonText\"\x98\x01\n" +
	"\x14LogoutDoneScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x124\n" +
	"\x11login_button_text\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0floginButtonText\"\xe8\x01\n" +
	"\n" +
	"FooterText\x12\x1a\n" +
	"\x03tos\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x03tos\x12/\n" +
	"\x0eprivacy_policy\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\rprivacyPolicy\x12\x1c\n" +
	"\x04help\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x04help\x12-\n" +
	"\rsupport_email\x18\a \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\fsupportEmailJ\x04\b\x02\x10\x03J\x04\b\x04\x10\x05J\x04\b\x06\x10\aJ\x04\b\b\x10\tR\btos_linkR\x13privacy_policy_linkR\thelp_link\"\xc8\x02\n" +
	"\x1cPasswordlessPromptScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x123\n" +
	"\x10description_init\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\x0fdescriptionInit\x12A\n" +
	"\x18passwordless_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x16passwordlessButtonText\x121\n" +
	"\x10next_button_text\x18\x05 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\x121\n" +
	"\x10skip_button_text\x18\x06 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0eskipButtonText\"\xc4\x02\n" +
	"\"PasswordlessRegistrationScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x122\n" +
	"\x10token_name_label\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x0etokenNameLabel\x12-\n" +
	"\rnot_supported\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\fnotSupported\x12D\n" +
	...
	"\verror_retry\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\n" +
	"errorRetry\"\x94\x02\n" +
	"&PasswordlessRegistrationDoneScreenText\x12\x1e\n" +
	"\x05title\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x05title\x12*\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xf4\x03R\vdescription\x121\n" +
	"\x10next_button_text\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\x0enextButtonText\x125\n" +
	"\x12cancel_button_text\x18\x04 \x01(\tB\a\xfaB\x04r\x02\x18dR\x10cancelButtonText\x124\n" +
	"\x11description_close\x18\x05 \x01(\tB\a\xfaB\x04r\x02\x18dR\x10descriptionCloseB*Z(github.com/zitadel/zitadel/pkg/grpc/textb\x06proto3"

var (
	file_zitadel_text_proto_rawDescOnce sync.Once
	file_zitadel_text_proto_rawDescData []byte
)

func file_zitadel_text_proto_rawDescGZIP() []byte {
	file_zitadel_text_proto_rawDescOnce.Do(func() {
		file_zitadel_text_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_text_proto_rawDesc), len(file_zitadel_text_proto_rawDesc)))
	})
	return file_zitadel_text_proto_rawDescData
}

var file_zitadel_text_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_zitadel_text_proto_goTypes = []any{
...
func file_zitadel_text_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_text_proto_rawDesc), len(file_zitadel_text_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   37,
			NumExtensions: 0,
			NumServices:   0,
