...
func (x *ResourceFilter) GetProjectGrant() *ResourceFilter_ProjectGrant {
	if x != nil {
		if x, ok := x.Resource.(*ResourceFilter_ProjectGrant_); ok {
			return x.ProjectGrant
		}
	}
	return nil
...
const file_zitadel_internal_permission_v2_query_proto_rawDesc = "" +
	"\n" +
	"*zitadel/internal_permission/v2/query.proto\x12\x1ezitadel.internal_permission.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\x1a\x1ezitadel/filter/v2/filter.proto\"\xf5\x03\n" +
	"\rAdministrator\x12?\n" +
	...
	"changeDate\x128\n" +
	"\x04user\x18\x03 \x01(\v2$.zitadel.internal_permission.v2.UserR\x04user\x12\x1c\n" +
	"\binstance\x18\x04 \x01(\bH\x00R\binstance\x12R\n" +
	"\forganization\x18\x05 \x01(\v2,.zitadel.internal_permission.v2.OrganizationH\x00R\forganization\x12C\n" +
	"\aproject\x18\x06 \x01(\v2'.zitadel.internal_permission.v2.ProjectH\x00R\aproject\x12S\n" +
	"\rproject_grant\x18\a \x01(\v2,.zitadel.internal_permission.v2.ProjectGrantH\x00R\fprojectGrant\x12\x14\n" +
	...
	"\x17granted_organization_id\x18\x05 \x01(\tR\x15grantedOrganizationId\"\x86\a\n" +
	"\x19AdministratorSearchFilter\x12I\n" +
	"\rcreation_date\x18\x01 \x01(\v2\".zitadel.filter.v2.TimestampFilterH\x00R\fcreationDate\x12E\n" +
	"\vchange_date\x18\x02 \x01(\v2\".zitadel.filter.v2.TimestampFilterH\x00R\n" +
	"changeDate\x12M\n" +
	"\x12in_user_ids_filter\x18\x03 \x01(\v2\x1e.zitadel.filter.v2.InIDsFilterH\x00R\x0finUserIdsFilter\x12O\n" +
	"\x14user_organization_id\x18\x04 \x01(\v2\x1b.zitadel.filter.v2.IDFilterH\x00R\x12userOrganizationId\x12y\n" +
	"\x19user_preferred_login_name\x18\x05 \x01(\v2<.zitadel.internal_permission.v2.UserPreferredLoginNameFilterH\x00R\x16userPreferredLoginName\x12c\n" +
	"\x11user_display_name\x18\x06 \x01(\v25.zitadel.internal_permission.v2.UserDisplayNameFilterH\x00R\x0fuserDisplayName\x12L\n" +
	"\bresource\x18\a \x01(\v2..zitadel.internal_permission.v2.ResourceFilterH\x00R\bresource\x12@\n" +
	"\x04role\x18\b \x01(\v2*.zitadel.internal_permission.v2.RoleFilterH\x00R\x04role\x12=\n" +
	"\x03and\x18\t \x01(\v2).zitadel.internal_permission.v2.AndFilterH\x00R\x03and\x12:\n" +
	"\x02or\x18\n" +
	" \x01(\v2(.zitadel.internal_permission.v2.OrFilterH\x00R\x02or\x12=\n" +
	"\x03not\x18\v \x01(\v2).zitadel.internal_permission.v2.NotFilterH\x00R\x03notB\r\n" +
	"\x06filter\x12\x03\xf8B\x01\"\xa7\x01\n" +
	"\x1cUserPreferredLoginNameFilter\x12@\n" +
	"\x14preferred_login_name\x18\x01 \x01(\tB\x0e\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x12preferredLoginName\x12E\n" +
	"\x06method\x18\x02 \x01(\x0e2#.zitadel.filter.v2.TextFilterMethodB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"\x91\x01\n" +
	"\x15UserDisplayNameFilter\x121\n" +
	"\fdisplay_name\x18\x01 \x01(\tB\x0e\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\vdisplayName\x12E\n" +
	"\x06method\x18\x02 \x01(\x0e2#.zitadel.filter.v2.TextFilterMethodB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"\xf0\x02\n" +
	...
	"\rproject_grant\x18\x04 \x01(\v2;.zitadel.internal_permission.v2.ResourceFilter.ProjectGrantH\x00R\fprojectGrant\x1av\n" +
	"\fProjectGrant\x12-\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tB\x0e\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tprojectId\x127\n" +
	"\x0forganization_id\x18\x02 \x01(\tB\x0e\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x0eorganizationIdB\x0f\n" +
	"\bresource\x12\x03\xf8B\x01\"7\n" +
	"\n" +
	"RoleFilter\x12)\n" +
	"\brole_key\x18\x01 \x01(\tB\x0e\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\aroleKey\"`\n" +
	"\tAndFilter\x12S\n" +
	"\aqueries\x18\x01 \x03(\v29.zitadel.internal_permission.v2.AdministratorSearchFilterR\aqueries\"_\n" +
	"\bOrFilter\x12S\n" +
	"\aqueries\x18\x01 \x03(\v29.zitadel.internal_permission.v2.AdministratorSearchFilterR\aqueries\"\\\n" +
	"\tNotFilter\x12O\n" +
	"\x05query\x18\x01 \x01(\v29.zitadel.internal_permission.v2.AdministratorSearchFilterR\x05query*\xbe\x01\n" +
	...
	"$ADMINISTRATOR_FIELD_NAME_CHANGE_DATE\x10\x03BPZNgithub.com/zitadel/zitadel/pkg/grpc/internal_permission/v2;internal_permissionb\x06proto3"

var (
	file_zitadel_internal_permission_v2_query_proto_rawDescOnce sync.Once
	file_zitadel_internal_permission_v2_query_proto_rawDescData []byte
)
...
func file_zitadel_internal_permission_v2_query_proto_rawDescGZIP() []byte {
	file_zitadel_internal_permission_v2_query_proto_rawDescOnce.Do(func() {
		file_zitadel_internal_permission_v2_query_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_internal_permission_v2_query_proto_rawDesc), len(file_zitadel_internal_permission_v2_query_proto_rawDesc)))
	})
...
var file_zitadel_internal_permission_v2_query_proto_goTypes = []any{
...
func file_zitadel_internal_permission_v2_query_proto_init() {
	...
	file_zitadel_internal_permission_v2_query_proto_msgTypes[0].OneofWrappers = []any{
		(*Administrator_Instance)(nil),
		(*Administrator_Organization)(nil),
		(*Administrator_Project)(nil),
		(*Administrator_ProjectGrant)(nil),
	}
	file_zitadel_internal_permission_v2_query_proto_msgTypes[5].OneofWrappers = []any{
	...
	file_zitadel_internal_permission_v2_query_proto_msgTypes[8].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_internal_permission_v2_query_proto_rawDesc), len(file_zitadel_internal_permission_v2_query_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
