...
type Organisation struct {
	...
	// Types that are valid to be assigned to Org:
	//
	//	*Organisation_OrgId
...
func (x *Organisation) GetOrg() isOrganisation_Org {
	if x != nil {
		return x.Org
	}
	return nil
...
func (x *Organisation) GetOrgId() string {
	if x != nil {
		if x, ok := x.Org.(*Organisation_OrgId); ok {
			return x.OrgId
		}
	}
	return ""
...
func (x *Organisation) GetOrgDomain() string {
	if x != nil {
		if x, ok := x.Org.(*Organisation_OrgDomain); ok {
			return x.OrgDomain
		}
	}
	return ""
...
func (x *Organization) GetOrg() isOrganization_Org {
	if x != nil {
		return x.Org
	}
	return nil
...
func (x *Organization) GetOrgId() string {
	if x != nil {
		if x, ok := x.Org.(*Organization_OrgId); ok {
			return x.OrgId
		}
	}
	return ""
...
func (x *Organization) GetOrgDomain() string {
	if x != nil {
		if x, ok := x.Org.(*Organization_OrgDomain); ok {
			return x.OrgDomain
		}
	}
	return ""
...
type RequestContext struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to ResourceOwner:
	//
...
func (x *RequestContext) GetResourceOwner() isRequestContext_ResourceOwner {
	if x != nil {
...
func (x *RequestContext) GetOrgId() string {
	if x != nil {
		if x, ok := x.ResourceOwner.(*RequestContext_OrgId); ok {
			return x.OrgId
		}
	}
	return ""
...
func (x *RequestContext) GetInstance() bool {
	if x != nil {
		if x, ok := x.ResourceOwner.(*RequestContext_Instance); ok {
			return x.Instance
		}
	}
	return false
...
const file_zitadel_object_v2beta_object_proto_rawDesc = "" +
	"\n" +
	"\"zitadel/object/v2beta/object.proto\x12\x15zitadel.object.v2beta\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"O\n" +
	"\fOrganisation\x12\x17\n" +
	"\x06org_id\x18\x01 \x01(\tH\x00R\x05orgId\x12\x1f\n" +
	"\n" +
	"org_domain\x18\x02 \x01(\tH\x00R\torgDomainB\x05\n" +
	"\x03org\"O\n" +
	...
	"\x06org_id\x18\x01 \x01(\tH\x00R\x05orgId\x12%\n" +
	"\binstance\x18\x02 \x01(\bB\a\xfaB\x04j\x02\b\x01H\x00R\binstanceB\x10\n" +
	...
	"changeDate\x12?\n" +
	"\x0eresource_owner\x18\x03 \x01(\tB\x18\x92A\x15J\x13\"69629023906488334\"R\rresourceOwner\x12?\n" +
	"\rcreation_date\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\fcreationDate\"\xe1\x01\n" +
	"\vListDetails\x12+\n" +
	"\ftotal_result\x18\x01 \x01(\x04B\b\x92A\x05J\x03\"2\"R\vtotalResult\x12<\n" +
	"\x12processed_sequence\x18\x02 \x01(\x04B\r\x92A\n" +
	"J\b\"267831\"R\x11processedSequence\x12g\n" +
	"\ttimestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampB-\x92A*2(the last time the projection got updatedR\ttimestamp*\xc5\x02\n" +
	...
	"%TIMESTAMP_QUERY_METHOD_LESS_OR_EQUALS\x10\x04B:Z8github.com/zitadel/zitadel/pkg/grpc/object/v2beta;objectb\x06proto3"

var (
	file_zitadel_object_v2beta_object_proto_rawDescOnce sync.Once
	file_zitadel_object_v2beta_object_proto_rawDescData []byte
)

func file_zitadel_object_v2beta_object_proto_rawDescGZIP() []byte {
	file_zitadel_object_v2beta_object_proto_rawDescOnce.Do(func() {
		file_zitadel_object_v2beta_object_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_object_v2beta_object_proto_rawDesc), len(file_zitadel_object_v2beta_object_proto_rawDesc)))
	})
...
var file_zitadel_object_v2beta_object_proto_goTypes = []any{
...
func file_zitadel_object_v2beta_object_proto_init() {
	...
	file_zitadel_object_v2beta_object_proto_msgTypes[0].OneofWrappers = []any{
		(*Organisation_OrgId)(nil),
		(*Organisation_OrgDomain)(nil),
	}
	file_zitadel_object_v2beta_object_proto_msgTypes[1].OneofWrappers = []any{
		(*Organization_OrgId)(nil),
		(*Organization_OrgDomain)(nil),
	}
	file_zitadel_object_v2beta_object_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_object_v2beta_object_proto_rawDesc), len(file_zitadel_object_v2beta_object_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
