...
const file_zitadel_object_v2_object_proto_rawDesc = "" +
	"\n" +
	"\x1ezitadel/object/v2/object.proto\x12\x11zitadel.object.v2\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"O\n" +
	...
	"%TIMESTAMP_QUERY_METHOD_LESS_OR_EQUALS\x10\x04B6Z4github.com/zitadel/zitadel/pkg/grpc/object/v2;objectb\x06proto3"

var (
	file_zitadel_object_v2_object_proto_rawDescOnce sync.Once
	file_zitadel_object_v2_object_proto_rawDescData []byte
)

func file_zitadel_object_v2_object_proto_rawDescGZIP() []byte {
	file_zitadel_object_v2_object_proto_rawDescOnce.Do(func() {
		file_zitadel_object_v2_object_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_object_v2_object_proto_rawDesc), len(file_zitadel_object_v2_object_proto_rawDesc)))
	})
...
var file_zitadel_object_v2_object_proto_goTypes = []any{
...
func file_zitadel_object_v2_object_proto_init() {
	...
	file_zitadel_object_v2_object_proto_msgTypes[0].OneofWrappers = []any{
		(*Organisation_OrgId)(nil),
		(*Organisation_OrgDomain)(nil),
	}
	file_zitadel_object_v2_object_proto_msgTypes[1].OneofWrappers = []any{
		(*Organization_OrgId)(nil),
		(*Organization_OrgDomain)(nil),
	}
	file_zitadel_object_v2_object_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_object_v2_object_proto_rawDesc), len(file_zitadel_object_v2_object_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
