...
const file_zitadel_org_v2_query_proto_rawDesc = "" +
	...
	"\x05query\x12\x03\xf8B\x01\"\x9a\x01\n" +
	"\x15OrganizationNameQuery\x12;\n" +
	"\x04name\x18\x01 \x01(\tB'\x92A\x16J\x0e\"gigi-giraffe\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x04name\x12D\n" +
	"\x06method\x18\x02 \x01(\x0e2\".zitadel.object.v2.TextQueryMethodB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"\xa1\x01\n" +
	"\x17OrganizationDomainQuery\x12@\n" +
	"\x06domain\x18\x01 \x01(\tB(\x92A\x17J\x0f\"citadel.cloud\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x06domain\x12D\n" +
