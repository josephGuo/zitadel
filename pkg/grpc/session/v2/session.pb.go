...
const file_zitadel_session_v2_session_proto_rawDesc = "" +
	...
	"\totp_email\x18\a \x01(\v2\x1d.zitadel.session.v2.OTPFactorR\botpEmail\x12K\n" +
	"\rrecovery_code\x18\b \x01(\v2&.zitadel.session.v2.RecoveryCodeFactorR\frecoveryCode\"\xdb\x01\n" +
	"\n" +
	"UserFactor\x12;\n" +
...
func file_zitadel_session_v2_session_proto_init() {
	...
	file_zitadel_session_v2_session_proto_msgTypes[9].OneofWrappers = []any{
	...
	file_zitadel_session_v2_session_proto_msgTypes[14].OneofWrappers = []any{}
	file_zitadel_session_v2_session_proto_msgTypes[16].OneofWrappers = []any{}
	type x struct{}
