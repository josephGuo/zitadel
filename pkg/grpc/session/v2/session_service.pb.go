...
const file_zitadel_session_v2_session_service_proto_rawDesc = "" +
	...
	"\bsessions\x18\x02 \x03(\v2\x1b.zitadel.session.v2.SessionR\bsessions\"\xc8\x01\n" +
	"\x11GetSessionRequest\x12L\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tB-\x92A\x1cJ\x14\"222430354126975533\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tsessionId\x12S\n" +
	...
	"challenges\"\xf3\x03\n" +
	"\x11SetSessionRequest\x12L\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tB-\x92A\x1cJ\x14\"222430354126975533\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tsessionId\x12'\n" +
	...
	"challenges\"\xa0\x01\n" +
	"\x14DeleteSessionRequest\x12L\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tB-\x92A\x1cJ\x14\"222430354126975533\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tsessionId\x12(\n" +
	"\rsession_token\x18\x02 \x01(\tH\x00R\fsessionToken\x88\x01\x01B\x10\n" +
	"\x0e_session_token\"M\n" +
	"\x15DeleteSessionResponse\x124\n" +
	"\adetails\x18\x01 \x01(\v2\x1a.zitadel.object.v2.DetailsR\adetails\"\x80\x05\n" +
	"\x06Checks\x126\n" +
	...
	"\totp_email\x18\a \x01(\v2\x1c.zitadel.session.v2.CheckOTPH\x06R\botpEmail\x88\x01\x01\x12O\n" +
	"\rrecovery_code\x18\b \x01(\v2%.zitadel.session.v2.CheckRecoveryCodeH\aR\frecoveryCode\x88\x01\x01B\a\n" +
	"\x05_userB\v\n" +
	"\t_passwordB\r\n" +
	"\v_web_auth_nB\r\n" +
	"\v_idp_intentB\a\n" +
	...
	"\n" +
	"_otp_emailB\x10\n" +
	"\x0e_recovery_code\"\xc2\x01\n" +
	"\tCheckUser\x12Z\n" +
	"\auser_id\x18\x01 \x01(\tB?\x92A.J&\"d654e6ba-70a3-48ef-a95d-37c8d8a7901a\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01H\x00R\x06userId\x12J\n" +
	"\n" +
	"login_name\x18\x02 \x01(\tB)\x92A\x18J\x10\"mini@mouse.com\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01H\x00R\tloginNameB\r\n" +
	"\x06search\x12\x03\xf8B\x01\"S\n" +
	"\rCheckPassword\x12B\n" +
	"\bpassword\x18\x01 \x01(\tB&\x92A\x15J\r\"V3ryS3cure!\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\bpassword\"|\n" +
	"\rCheckWebAuthN\x12k\n" +
	"\x19credential_assertion_data\x18\x01 \x01(\v2\x17.google.protobuf.StructB\x16\x92A\ax\x80\x80@\x80\x017\xe2A\x01\x02\xfaB\x05\x8a\x01\x02\x10\x01R\x17credentialAssertionData\"\xde\x01\n" +
	"\x0eCheckIDPIntent\x12c\n" +
	"\ridp_intent_id\x18\x01 \x01(\tB?\x92A.J&\"d654e6ba-70a3-48ef-a95d-37c8d8a7901a\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\vidpIntentId\x12g\n" +
	"\x10idp_intent_token\x18\x02 \x01(\tB=\x92A,J$\"SJKL3ioIDpo342ioqw98fjp3sdf32wahb=\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x0eidpIntentToken\"@\n" +
	"\tCheckTOTP\x123\n" +
	"\x04code\x18\x01 \x01(\tB\x1f\x92A\x0fJ\b\"323764\"x\x06\x80\x01\x06\xe2A\x01\x02\xfaB\x06r\x04\x10\x06\x18\x06R\x04code\"<\n" +
	"\bCheckOTP\x120\n" +
	"\x04code\x18\x01 \x01(\tB\x1c\x92A\x0eJ\t\"3237642\"\x80\x01\x01\xe2A\x01\x02\xfaB\x04r\x02\x10\x01R\x04code\"J\n" +
	"\x11CheckRecoveryCode\x125\n" +
	"\x04code\x18\x01 \x01(\tB!\x92A\x14J\f\"1234567890\"x\xc8\x01\x80\x01\x01\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x04code2\x9e\a\n" +
