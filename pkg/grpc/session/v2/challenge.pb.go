...
const file_zitadel_session_v2_challenge_proto_rawDesc = "" +
	"\n" +
	"\"zitadel/session/v2/challenge.proto\x12\x12zitadel.session.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"\x94\a\n" +
	...
	"\totp_email\x18\x03 \x01(\v2..zitadel.session.v2.RequestChallenges.OTPEmailH\x02R\botpEmail\x88\x01\x01\x1a\xb8\x01\n" +
	"\bWebAuthN\x12&\n" +
	"\x06domain\x18\x01 \x01(\tB\x0e\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x06domain\x12\x83\x01\n" +
	"\x1duser_verification_requirement\x18\x02 \x01(\x0e2/.zitadel.session.v2.UserVerificationRequirementB\x0e\xe2A\x01\x02\xfaB\a\x82\x01\x04\x10\x01 \x00R\x1buserVerificationRequirement\x1a)\n" +
	"\x06OTPSMS\x12\x1f\n" +
