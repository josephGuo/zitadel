...
const file_zitadel_session_v2beta_challenge_proto_rawDesc = "" +
	"\n" +
	"&zitadel/session/v2beta/challenge.proto\x12\x16zitadel.session.v2beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"\xc0\v\n" +
	...
	"\totp_email\x18\x03 \x01(\v22.zitadel.session.v2beta.RequestChallenges.OTPEmailH\x02R\botpEmail\x88\x01\x01\x1a\x91\x04\n" +
	"\bWebAuthN\x12}\n" +
	"\x06domain\x18\x01 \x01(\tBe\x92AT2R\"Domain on which the session was created. Will be used in the WebAuthN challenge.\"\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x06domain\x12\x85\x03\n" +
	"\x1duser_verification_requirement\x18\x02 \x01(\x0e23.zitadel.session.v2beta.UserVerificationRequirementB\x8b\x02\x92A\xf9\x01\x1a@https://www.w3.org/TR/webauthn/#enum-userVerificationRequirement2\xb4\x01\"User verification that is required during validation. When set to `USER_VERIFICATION_REQUIREMENT_REQUIRED` the behaviour is for passkey authentication. Other values will mean U2F\"\xe2A\x01\x02\xfaB\a\x82\x01\x04\x10\x01 \x00R\x1buserVerificationRequirement\x1a)\n" +
	"\x06OTPSMS\x12\x1f\n" +
