...
func (x *Application) GetConfiguration() isApplication_Configuration {
	if x != nil {
...
func (x *Application) GetOidcConfiguration() *OIDCConfiguration {
	if x != nil {
		if x, ok := x.Configuration.(*Application_OidcConfiguration); ok {
...
func (x *Application) GetApiConfiguration() *APIConfiguration {
	if x != nil {
		if x, ok := x.Configuration.(*Application_ApiConfiguration); ok {
...
func (x *Application) GetSamlConfiguration() *SAMLConfiguration {
	if x != nil {
		if x, ok := x.Configuration.(*Application_SamlConfiguration); ok {
...
func (x *ApplicationSearchFilter) GetProjectIdFilter() *ProjectIDFilter {
	if x != nil {
		if x, ok := x.Filter.(*ApplicationSearchFilter_ProjectIdFilter); ok {
...
func (x *ApplicationSearchFilter) GetTypeFilter() ApplicationType {
	if x != nil {
		if x, ok := x.Filter.(*ApplicationSearchFilter_TypeFilter); ok {
			return x.TypeFilter
		}
	}
...
func (x *ApplicationKeySearchFilter) GetApplicationIdFilter() *ApplicationKeyApplicationIDFilter {
	if x != nil {
		if x, ok := x.Filter.(*ApplicationKeySearchFilter_ApplicationIdFilter); ok {
...
func (x *ApplicationKeySearchFilter) GetProjectIdFilter() *ApplicationKeyProjectIDFilter {
	if x != nil {
		if x, ok := x.Filter.(*ApplicationKeySearchFilter_ProjectIdFilter); ok {
			return x.ProjectIdFilter
		}
	}
	return nil
...
func (x *ApplicationKeySearchFilter) GetOrganizationIdFilter() *ApplicationKeyOrganizationIDFilter {
	if x != nil {
		if x, ok := x.Filter.(*ApplicationKeySearchFilter_OrganizationIdFilter); ok {
...
const file_zitadel_application_v2_application_proto_rawDesc = "" +
	...
	"changeDate\x12>\n" +
	"\x05state\x18\x04 \x01(\x0e2(.zitadel.application.v2.ApplicationStateR\x05state\x12\"\n" +
	...
	"\x16organization_id_filter\x18\x03 \x01(\v2:.zitadel.application.v2.ApplicationKeyOrganizationIDFilterH\x00R\x14organizationIdFilterB\r\n" +
	"\x06filter\x12\x03\xf8B\x01\"p\n" +
	"!ApplicationKeyApplicationIDFilter\x12K\n" +
	"\x0eapplication_id\x18\x01 \x01(\tB$\x92A\x15J\x13\"69629023906488334\"\xe2A\x01\x02\xfaB\x05r\x03\x18\xc8\x01R\rapplicationId\"f\n" +
	"\x1dApplicationKeyProjectIDFilter\x12E\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tB&\x92A\x15J\x13\"69629023906488334\"\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tprojectId\"u\n" +
	"\"ApplicationKeyOrganizationIDFilter\x12O\n" +
	"\x0forganization_id\x18\x01 \x01(\tB&\x92A\x15J\x13\"69629023906488334\"\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x0eorganizationId\"\xde\x02\n" +
	"\x0eApplicationKey\x12\x15\n" +
	...
	"\x0fexpiration_date\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB\x1f\x92A\x1cJ\x1a\"2024-12-18T07:50:47.492Z\"R\x0eexpirationDate*\x92\x01\n" +
	"\x10ApplicationState\x12!\n" +
	"\x1dAPPLICATION_STATE_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18APPLICATION_STATE_ACTIVE\x10\x01\x12\x1e\n" +
	"\x1aAPPLICATION_STATE_INACTIVE\x10\x02\x12\x1d\n" +
	"\x19APPLICATION_STATE_REMOVED\x10\x03*\xb9\x01\n" +
	"\x12ApplicationSorting\x12\x1a\n" +
	"\x16APPLICATION_SORT_BY_ID\x10\x00\x12\x1c\n" +
	"\x18APPLICATION_SORT_BY_NAME\x10\x01\x12\x1d\n" +
	"\x19APPLICATION_SORT_BY_STATE\x10\x02\x12%\n" +
	"!APPLICATION_SORT_BY_CREATION_DATE\x10\x03\x12#\n" +
	"\x1fAPPLICATION_SORT_BY_CHANGE_DATE\x10\x04*\x83\x01\n" +
	"\x0fApplicationType\x12 \n" +
	"\x1cAPPLICATION_TYPE_UNSPECIFIED\x10\x00\x12\x19\n" +
	"\x15APPLICATION_TYPE_OIDC\x10\x01\x12\x18\n" +
	"\x14APPLICATION_TYPE_API\x10\x02\x12\x19\n" +
	"\x15APPLICATION_TYPE_SAML\x10\x03*\xb5\x02\n" +
	...
	"\x1dAPPLICATION_KEYS_SORT_BY_TYPE\x10\x06B@Z>github.com/zitadel/zitadel/pkg/grpc/application/v2;applicationb\x06proto3"

var (
	file_zitadel_application_v2_application_proto_rawDescOnce sync.Once
	file_zitadel_application_v2_application_proto_rawDescData []byte
)
...
func file_zitadel_application_v2_application_proto_rawDescGZIP() []byte {
	file_zitadel_application_v2_application_proto_rawDescOnce.Do(func() {
		file_zitadel_application_v2_application_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_application_v2_application_proto_rawDesc), len(file_zitadel_application_v2_application_proto_rawDesc)))
	})
...
func file_zitadel_application_v2_application_proto_init() {
	...
	file_zitadel_application_v2_application_proto_msgTypes[0].OneofWrappers = []any{
		(*Application_OidcConfiguration)(nil),
		(*Application_ApiConfiguration)(nil),
		(*Application_SamlConfiguration)(nil),
	}
	file_zitadel_application_v2_application_proto_msgTypes[1].OneofWrappers = []any{
