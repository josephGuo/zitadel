...
const file_zitadel_application_v2_oidc_proto_rawDesc = "" +
	"\n" +
	"!zitadel/application/v2/oidc.proto\x12\x16zitadel.application.v2\x1a\x1egoogle/protobuf/duration.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\"zitadel/application/v2/login.proto\"U\n" +
	"\x14OIDCLocalizedMessage\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12+\n" +
	"\x11localized_message\x18\x02 \x01(\tR\x10localizedMessage\"\xdb\f\n" +
	"\x11OIDCConfiguration\x12V\n" +
	"\rredirect_uris\x18\x01 \x03(\tB1\x92A.J,[\"https://console.zitadel.ch/auth/callback\"]R\fredirectUris\x12O\n" +
	...
	"grantTypes\x12\x87\x01\n" +
	"\x10application_type\x18\x04 \x01(\x0e2+.zitadel.application.v2.OIDCApplicationTypeB/\x92A,2*determines the paradigm of the applicationR\x0fapplicationType\x12=\n" +
	"\tclient_id\x18\x05 \x01(\tB \x92A\x1dJ\x1b\"69629023906488334@ZITADEL\"R\bclientId\x12T\n" +
	"\x10auth_method_type\x18\x06 \x01(\x0e2*.zitadel.application.v2.OIDCAuthMethodTypeR\x0eauthMethodType\x12e\n" +
	"\x19post_logout_redirect_uris\x18\a \x03(\tB*\x92A'J%[\"https://console.zitadel.ch/logout\"]R\x16postLogoutRedirectUris\x12=\n" +
	"\aversion\x18\b \x01(\x0e2#.zitadel.application.v2.OIDCVersionR\aversion\x12#\n" +
	"\rnon_compliant\x18\t \x01(\bR\fnonCompliant\x12]\n" +
	"\x13compliance_problems\x18\n" +
	" \x03(\v2,.zitadel.application.v2.OIDCLocalizedMessageR\x12complianceProblems\x12)\n" +
	"\x10development_mode\x18\v \x01(\bR\x0fdevelopmentMode\x12Q\n" +
	"\x11access_token_type\x18\f \x01(\x0e2%.zitadel.application.v2.OIDCTokenTypeR\x0faccessTokenType\x12=\n" +
	"\x1baccess_token_role_assertion\x18\r \x01(\bR\x18accessTokenRoleAssertion\x125\n" +
	"\x17id_token_role_assertion\x18\x0e \x01(\bR\x14idTokenRoleAssertion\x12=\n" +
	"\x1bid_token_userinfo_assertion\x18\x0f \x01(\bR\x18idTokenUserinfoAssertion\x128\n" +
	"\n" +
	"clock_skew\x18\x10 \x01(\v2\x19.google.protobuf.DurationR\tclockSkew\x12`\n" +
	"\x12additional_origins\x18\x11 \x03(\tB1\x92A.J,[\"https://console.zitadel.ch/auth/callback\"]R\x11additionalOrigins\x12L\n" +
	"\x0fallowed_origins\x18\x12 \x03(\tB#\x92A J\x1e[\"https://console.zitadel.ch\"]R\x0eallowedOrigins\x12>\n" +
	"\x1cskip_native_app_success_page\x18\x13 \x01(\bR\x18skipNativeAppSuccessPage\x12d\n" +
	"\x17back_channel_logout_uri\x18\x14 \x01(\tB-\x92A*J([\"https://example.com/auth/backchannel\"]R\x14backChannelLogoutUri\x12I\n" +
	"\rlogin_version\x18\x15 \x01(\v2$.zitadel.application.v2.LoginVersionR\floginVersion*\x9b\x01\n" +
	...
	"\x1eOIDC_GRANT_TYPE_TOKEN_EXCHANGE\x10\x04*d\n" +
	"\x13OIDCApplicationType\x12\x15\n" +
	...
	"\x13OIDC_TOKEN_TYPE_JWT\x10\x01B@Z>github.com/zitadel/zitadel/pkg/grpc/application/v2;applicationb\x06proto3"

var (
	file_zitadel_application_v2_oidc_proto_rawDescOnce sync.Once
	file_zitadel_application_v2_oidc_proto_rawDescData []byte
)

func file_zitadel_application_v2_oidc_proto_rawDescGZIP() []byte {
	file_zitadel_application_v2_oidc_proto_rawDescOnce.Do(func() {
		file_zitadel_application_v2_oidc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_application_v2_oidc_proto_rawDesc), len(file_zitadel_application_v2_oidc_proto_rawDesc)))
	})
...
var file_zitadel_application_v2_oidc_proto_goTypes = []any{
...
func file_zitadel_application_v2_oidc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_application_v2_oidc_proto_rawDesc), len(file_zitadel_application_v2_oidc_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
