...
const file_zitadel_auth_proto_rawDesc = "" +
	...
	"\x06policy\x18\x01 \x01(\v2+.zitadel.policy.v1.PasswordComplexityPolicyR\x06policy\"\xb1\x01\n" +
	"\x17UpdateMyPasswordRequest\x12J\n" +
	"\fold_password\x18\x01 \x01(\tB'\x92A\x17J\x12\"MyOldPassword12!\"\x80\x01\x01\xe2A\x01\x02\xfaB\x06r\x04\x10\x01(FR\voldPassword\x12J\n" +
	"\fnew_password\x18\x02 \x01(\tB'\x92A\x17J\x12\"MyNewPassword12!\"\x80\x01\x01\xe2A\x01\x02\xfaB\x06r\x04\x10\x01(FR\vnewPassword\"O\n" +
	...
	"\aprofile\x18\x02 \x01(\v2\x18.zitadel.user.v1.ProfileR\aprofile\"\x93\x03\n" +
	"\x16UpdateMyProfileRequest\x12@\n" +
	"\n" +
	"first_name\x18\x01 \x01(\tB!\x92A\x10J\b\"Minnie\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tfirstName\x12=\n" +
	"\tlast_name\x18\x02 \x01(\tB \x92A\x0fJ\a\"Mouse\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\blastName\x128\n" +
	"\tnick_name\x18\x03 \x01(\tB\x1b\x92A\x10J\b\"Minnie\"x\xc8\x01\x80\x01\x01\xfaB\x05r\x03\x18\xc8\x01R\bnickName\x12J\n" +
	"\fdisplay_name\x18\x04 \x01(\tB'\x92A\x16J\x0e\"Minnie Mouse\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\vdisplayName\x12A\n" +
	...
	"\x05email\x18\x02 \x01(\v2\x16.zitadel.user.v1.EmailR\x05email\"M\n" +
	"\x11SetMyEmailRequest\x128\n" +
	"\x05email\x18\x01 \x01(\tB\"\x92A\x14J\x12\"gigi@zitadel.com\"\xe2A\x01\x02\xfaB\x04r\x02`\x01R\x05email\"I\n" +
	"\x12SetMyEmailResponse\x123\n" +
	"\adetails\x18\x01 \x01(\v2\x19.zitadel.v1.ObjectDetailsR\adetails\"L\n" +
	"\x14VerifyMyEmailRequest\x124\n" +
	"\x04code\x18\x01 \x01(\tB \x92A\x0fJ\a\"H83J3\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x04code\"L\n" +
	...
	"\adetails\x18\x01 \x01(\v2\x19.zitadel.v1.ObjectDetailsR\adetails\x12,\n" +
	"\x05phone\x18\x02 \x01(\v2\x16.zitadel.user.v1.PhoneR\x05phone\"W\n" +
	"\x11SetMyPhoneRequest\x12B\n" +
	"\x05phone\x18\x01 \x01(\tB,\x92A\x19J\x12\"+41 71 000 00 00\"x2\x80\x01\x01\xe2A\x01\x02\xfaB\tr\a\x10\x01\x182:\x01+R\x05phone\"I\n" +
	"\x12SetMyPhoneResponse\x123\n" +
	"\adetails\x18\x01 \x01(\v2\x19.zitadel.v1.ObjectDetailsR\adetails\"L\n" +
	"\x14VerifyMyPhoneRequest\x124\n" +
	"\x04code\x18\x01 \x01(\tB \x92A\x0fJ\a\"H83J3\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x04code\"L\n" +
	...
	"\adetails\x18\x03 \x01(\v2\x19.zitadel.v1.ObjectDetailsR\adetails\"O\n" +
	"\x1cVerifyMyAuthFactorOTPRequest\x12/\n" +
	"\x04code\x18\x01 \x01(\tB\x1b\x92A\n" +
	"J\b\"123456\"\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x04code\"T\n" +
