...
const file_zitadel_oidc_v2_oidc_service_proto_rawDesc = "" +
	"\n" +
	"\"zitadel/oidc/v2/oidc_service.proto\x12\x0fzitadel.oidc.v2\x1a\x1ezitadel/object/v2/object.proto\x1a+zitadel/protoc_gen_zitadel/v2/options.proto\x1a#zitadel/oidc/v2/authorization.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"n\n" +
	"\x15GetAuthRequestRequest\x12U\n" +
	"\x0fauth_request_id\x18\x01 \x01(\tB-\x92A\x1cJ\x14\"163840776835432705\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\rauthRequestId\"Y\n" +
	"\x16GetAuthRequestResponse\x12?\n" +
	"\fauth_request\x18\x01 \x01(\v2\x1c.zitadel.oidc.v2.AuthRequestR\vauthRequest\"\xf1\x01\n" +
	"\x15CreateCallbackRequest\x12O\n" +
	"\x0fauth_request_id\x18\x01 \x01(\tB'\x92A\x16J\x14\"163840776835432705\"\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\rauthRequestId\x124\n" +
	...
	"\rcallback_kind\x12\x03\xf8B\x01\"\x95\x01\n" +
	"\aSession\x12L\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tB-\x92A\x1cJ\x14\"163840776835432705\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tsessionId\x12<\n" +
	"\rsession_token\x18\x02 \x01(\tB\x17\x92A\x06x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\fsessionToken\"\xc5\x01\n" +
	"\x16CreateCallbackResponse\x124\n" +
	"\adetails\x18\x01 \x01(\v2\x1a.zitadel.object.v2.DetailsR\adetails\x12u\n" +
	"\fcallback_url\x18\x02 \x01(\tBR\x92AOJM\"https://client.example.org/cb?code=SplxlOBeZQQYbYS6WxSbIA&state=af0ifjsldkj\"R\vcallbackUrl\"f\n" +
	"$GetDeviceAuthorizationRequestRequest\x12>\n" +
	"\tuser_code\x18\x01 \x01(\tB!\x92A\x12J\v\"K9LV-3DMQ\"x\t\x80\x01\t\xe2A\x01\x02\xfaB\x05r\x03\x98\x01\tR\buserCode\"\x96\x01\n" +
	"%GetDeviceAuthorizationRequestResponse\x12m\n" +
	"\x1cdevice_authorization_request\x18\x01 \x01(\v2+.zitadel.oidc.v2.DeviceAuthorizationRequestR\x1adeviceAuthorizationRequest\"\xf0\x01\n" +
	")AuthorizeOrDenyDeviceAuthorizationRequest\x12O\n" +
	"\x17device_authorization_id\x18\x01 \x01(\tB\x17\x92A\x06x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x15deviceAuthorizationId\x124\n" +
	"\asession\x18\x02 \x01(\v2\x18.zitadel.oidc.v2.SessionH\x00R\asession\x12+\n" +
