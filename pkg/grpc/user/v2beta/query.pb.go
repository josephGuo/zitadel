...
const file_zitadel_user_v2beta_query_proto_rawDesc = "" +
	...
	"\rInUserIDQuery\x12j\n" +
	"\buser_ids\x18\x01 \x03(\tBO\x92AL2\x1fthe ids of the users to includeJ)[\"69629023906488334\",\"69622366012355662\"]R\auserIds\"\xce\x01\n" +
	"\rUserNameQuery\x12D\n" +
	"\tuser_name\x18\x01 \x01(\tB'\x92A\x16J\x0e\"gigi-giraffe\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\buserName\x12w\n" +
	"\x06method\x18\x02 \x01(\x0e2&.zitadel.object.v2beta.TextQueryMethodB7\x92A,2*defines which text equality method is used\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"\xc9\x01\n" +
	"\x0eFirstNameQuery\x12>\n" +
	"\n" +
	"first_name\x18\x01 \x01(\tB\x1f\x92A\x0eJ\x06\"Gigi\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tfirstName\x12w\n" +
	"\x06method\x18\x02 \x01(\x0e2&.zitadel.object.v2beta.TextQueryMethodB7\x92A,2*defines which text equality method is used\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"\xc9\x01\n" +
	"\rLastNameQuery\x12?\n" +
	"\tlast_name\x18\x01 \x01(\tB\"\x92A\x11J\t\"Giraffe\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\blastName\x12w\n" +
	"\x06method\x18\x02 \x01(\x0e2&.zitadel.object.v2beta.TextQueryMethodB7\x92A,2*defines which text equality method is used\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"\xc6\x01\n" +
	"\rNickNameQuery\x12<\n" +
	"\tnick_name\x18\x01 \x01(\tB\x1f\x92A\x0eJ\x06\"Gigi\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\bnickName\x12w\n" +
	"\x06method\x18\x02 \x01(\x0e2&.zitadel.object.v2beta.TextQueryMethodB7\x92A,2*defines which text equality method is used\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"\xd7\x01\n" +
	"\x10DisplayNameQuery\x12J\n" +
	"\fdisplay_name\x18\x01 \x01(\tB'\x92A\x16J\x0e\"Gigi Giraffe\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\vdisplayName\x12w\n" +
	"\x06method\x18\x02 \x01(\x0e2&.zitadel.object.v2beta.TextQueryMethodB7\x92A,2*defines which text equality method is used\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"\xed\x01\n" +
	"\n" +
	"EmailQuery\x12f\n" +
	"\remail_address\x18\x01 \x01(\tBA\x92A22\x19email address of the userJ\x12\"gigi@zitadel.com\"x\xc8\x01\xe2A\x01\x02\xfaB\x05r\x03\x18\xc8\x01R\femailAddress\x12w\n" +
	"\x06method\x18\x02 \x01(\x0e2&.zitadel.object.v2beta.TextQueryMethodB7\x92A,2*defines which text equality method is used\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"\xdc\x01\n" +
	"\n" +
	"PhoneQuery\x12U\n" +
	"\x06number\x18\x01 \x01(\tB=\x92A/2\x18Phone number of the userJ\x0e\"+41791234567\"x\x14\x80\x01\x01\xe2A\x01\x02\xfaB\x04r\x02\x18\x14R\x06number\x12w\n" +
	"\x06method\x18\x02 \x01(\x0e2&.zitadel.object.v2beta.TextQueryMethodB7\x92A,2*defines which text equality method is used\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"\xd7\x01\n" +
	"\x0eLoginNameQuery\x12L\n" +
	"\n" +
	"login_name\x18\x01 \x01(\tB-\x92A\x1cJ\x14\"gigi@zitadel.cloud\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tloginName\x12w\n" +
	"\x06method\x18\x02 \x01(\x0e2&.zitadel.object.v2beta.TextQueryMethodB7\x92A,2*defines which text equality method is used\xfaB\x05\x82\x01\x02\x10\x01R\x06method\"n\n" +
	"\n" +
	"StateQuery\x12`\n" +
	"\x05state\x18\x01 \x01(\x0e2\x1e.zitadel.user.v2beta.UserStateB*\x92A\x1b2\x19current state of the user\xe2A\x01\x02\xfaB\x05\x82\x01\x02\x10\x01R\x05state\"a\n" +
	"\tTypeQuery\x12T\n" +
	"\x04type\x18\x01 \x01(\x0e2\x19.zitadel.user.v2beta.TypeB%\x92A\x162\x14the type of the user\xe2A\x01\x02\xfaB\x05\x82\x01\x02\x10\x01R\x04type\"\x86\x01\n" +
