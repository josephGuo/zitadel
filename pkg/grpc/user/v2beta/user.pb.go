...
const file_zitadel_user_v2beta_user_proto_rawDesc = "" +
	"\n" +
	"\x1ezitadel/user/v2beta/user.proto\x12\x13zitadel.user.v2beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\x1a\"zitadel/object/v2beta/object.proto\x1a\x1fzitadel/user/v2beta/email.proto\x1a\x1fzitadel/user/v2beta/phone.proto\"\xf1\x03\n" +
	"\x0fSetHumanProfile\x12@\n" +
	"\n" +
	"given_name\x18\x01 \x01(\tB!\x92A\x10J\b\"Minnie\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tgivenName\x12A\n" +
	"\vfamily_name\x18\x02 \x01(\tB \x92A\x0fJ\a\"Mouse\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\n" +
	"familyName\x128\n" +
	...
	"\xfaB\x04r\x02\x18\n" +
	"H\x02R\x11preferredLanguage\x88\x01\x01\x12N\n" +
	"\x06gender\x18\x06 \x01(\x0e2\x1b.zitadel.user.v2beta.GenderB\x14\x92A\x11J\x0f\"GENDER_FEMALE\"H\x03R\x06gender\x88\x01\x01B\f\n" +
	"\n" +
	"_nick_nameB\x0f\n" +
	"\r_display_nameB\x15\n" +
	...
	"H\x02R\x11preferredLanguage\x88\x01\x01\x12N\n" +
	"\x06gender\x18\x06 \x01(\x0e2\x1b.zitadel.user.v2beta.GenderB\x14\x92A\x11J\x0f\"GENDER_FEMALE\"H\x03R\x06gender\x88\x01\x01\x12s\n" +
	"\n" +
	...
	"\x13_preferred_languageB\t\n" +
	"\a_gender\"\xbd\x01\n" +
	"\x10SetMetadataEntry\x123\n" +
	"\x03key\x18\x01 \x01(\tB!\x92A\x10J\b\"my-key\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x03key\x12t\n" +
	"\x05value\x18\x02 \x01(\fB^\x92AL2#The value has to be base64 encoded.J\x1e\"VGhpcyBpcyBteSB0ZXN0IHZhbHVl\"x\xa0\xc2\x1e\x80\x01\x01\xe2A\x01\x02\xfaB\bz\x06\x10\x01\x18\xa0\xc2\x1eR\x05value\"\xa6\x05\n" +
	"\tHumanUser\x12D\n" +
	"\auser_id\x18\x01 \x01(\tB+\x92A(J&\"d654e6ba-70a3-48ef-a95d-37c8d8a7901a\"R\x06userId\x12T\n" +
	"\x05state\x18\x02 \x01(\x0e2\x1e.zitadel.user.v2beta.UserStateB\x1e\x92A\x1b2\x19current state of the userR\x05state\x12/\n" +
	...
	"loginNames\x12I\n" +
	"\x14preferred_login_name\x18\x05 \x01(\tB\x17\x92A\x14J\x12\"gigi@zitadel.com\"R\x12preferredLoginName\x12;\n" +
	"\aprofile\x18\x06 \x01(\v2!.zitadel.user.v2beta.HumanProfileR\aprofile\x125\n" +
	"\x05email\x18\a \x01(\v2\x1f.zitadel.user.v2beta.HumanEmailR\x05email\x125\n" +
	"\x05phone\x18\b \x01(\v2\x1f.zitadel.user.v2beta.HumanPhoneR\x05phone\x128\n" +
	"\x18password_change_required\x18\t \x01(\bR\x16passwordChangeRequired\x12E\n" +
	"\x10password_changed\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\x0fpasswordChanged\"\xfb\x04\n" +
	"\x04User\x12D\n" +
	"\auser_id\x18\x01 \x01(\tB+\x92A(J&\"d654e6ba-70a3-48ef-a95d-37c8d8a7901a\"R\x06userId\x128\n" +
	"\adetails\x18\b \x01(\v2\x1e.zitadel.object.v2beta.DetailsR\adetails\x12T\n" +
	"\x05state\x18\x02 \x01(\x0e2\x1e.zitadel.user.v2beta.UserStateB\x1e\x92A\x1b2\x19current state of the userR\x05state\x12/\n" +
	"\busername\x18\x03 \x01(\tB\x13\x92A\x10J\x0e\"minnie-mouse\"R\busername\x12U\n" +
	"\vlogin_names\x18\x04 \x03(\tB4\x92A1J/[\"gigi@zitadel.com\", \"gigi@zitadel.zitadel.ch\"]R\n" +
	"loginNames\x12I\n" +
	"\x14preferred_login_name\x18\x05 \x01(\tB\x17\x92A\x14J\x12\"gigi@zitadel.com\"R\x12preferredLoginName\x12]\n" +
	"\x05human\x18\x06 \x01(\v2\x1e.zitadel.user.v2beta.HumanUserB%\x92A\"2 one of type use human or machineH\x00R\x05human\x12c\n" +
	"\amachine\x18\a \x01(\v2 .zitadel.user.v2beta.MachineUserB%\x92A\"2 one of type use human or machineH\x00R\amachineB\x06\n" +
	"\x04type\"\x94\x02\n" +
	"\vMachineUser\x12\"\n" +
	...
	"\n" +
	"has_secret\x18\x03 \x01(\bB\v\x92A\bJ\x06\"true\"R\thasSecret\x12v\n" +
	"\x11access_token_type\x18\x04 \x01(\x0e2$.zitadel.user.v2beta.AccessTokenTypeB$\x92A!2\x1fType of access token to receiveR\x0faccessTokenType*X\n" +
	"\x06Gender\x12\x16\n" +
	...
	"\x12USER_STATE_INITIAL\x10\x05B6Z4github.com/zitadel/zitadel/pkg/grpc/user/v2beta;userb\x06proto3"

var (
	file_zitadel_user_v2beta_user_proto_rawDescOnce sync.Once
	file_zitadel_user_v2beta_user_proto_rawDescData []byte
)

func file_zitadel_user_v2beta_user_proto_rawDescGZIP() []byte {
	file_zitadel_user_v2beta_user_proto_rawDescOnce.Do(func() {
		file_zitadel_user_v2beta_user_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_user_v2beta_user_proto_rawDesc), len(file_zitadel_user_v2beta_user_proto_rawDesc)))
	})
...
var file_zitadel_user_v2beta_user_proto_goTypes = []any{
...
func file_zitadel_user_v2beta_user_proto_init() {
	...
	file_zitadel_user_v2beta_user_proto_msgTypes[0].OneofWrappers = []any{}
	file_zitadel_user_v2beta_user_proto_msgTypes[1].OneofWrappers = []any{}
	file_zitadel_user_v2beta_user_proto_msgTypes[4].OneofWrappers = []any{
		(*User_Human)(nil),
		(*User_Machine)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_user_v2beta_user_proto_rawDesc), len(file_zitadel_user_v2beta_user_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
