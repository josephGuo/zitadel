...
const file_zitadel_user_v2beta_password_proto_rawDesc = "" +
	"\n" +
	"\"zitadel/user/v2beta/password.proto\x12\x13zitadel.user.v2beta\x1a\x1fgoogle/api/field_behavior.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"{\n" +
	"\bPassword\x12F\n" +
	...
	"\x0fhashed_password\x18\x02 \x01(\v2#.zitadel.user.v2beta.HashedPasswordH\x00R\x0ehashedPassword\x12W\n" +
