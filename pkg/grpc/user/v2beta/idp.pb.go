...
const file_zitadel_user_v2beta_idp_proto_rawDesc = "" +
	"\n" +
	"\x1dzitadel/user/v2beta/idp.proto\x12\x13zitadel.user.v2beta\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\"\xda\x01\n" +
	...
	"\auser_id\x18\x03 \x01(\tBT\x92AQ26ID of the Zitadel user if external user already linkedJ\x14\"163840776835432345\"x\xc8\x01R\x06userId\"\xd8\x06\n" +
	"\x0eIDPInformation\x12\x8f\x01\n" +
	"\x05oauth\x18\x01 \x01(\v2..zitadel.user.v2beta.IDPOAuthAccessInformationBG\x92AD2BOAuth/OIDC access (and id_token) returned by the identity providerH\x00R\x05oauth\x12\x82\x01\n" +
	"\x04ldap\x18\x06 \x01(\v2-.zitadel.user.v2beta.IDPLDAPAccessInformationB=\x92A:28LDAP entity attributes returned by the identity providerH\x00R\x04ldap\x12x\n" +
	"\x04saml\x18\a \x01(\v2-.zitadel.user.v2beta.IDPSAMLAccessInformationB3\x92A02.SAMLResponse returned by the identity providerH\x00R\x04saml\x12_\n" +
	...
	"\tuser_name\x18\x03 \x01(\tBW\x92AJ2-username of the user of the identity providerJ\x13\"user@external.com\"x\xc8\x01\x80\x01\x01\xfaB\ar\x05\x10\x01\x18\xc8\x01R\buserName\"\xfc\x01\n" +
	"\bFormData\x124\n" +
	"\x03url\x18\x01 \x01(\tB\"\x92A\x1fJ\x1d\"https://idp.com/saml/v2/acs\"R\x03url\x12\x7f\n" +
	"\x06fields\x18\x02 \x03(\v2).zitadel.user.v2beta.FormData.FieldsEntryB<\x92A9J7{\"relayState\":\"state\",\"SAMLRequest\":\"asjfkj3ir2fj248=\"}R\x06fields\x1a9\n" +
	"\vFieldsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B6Z4github.com/zitadel/zitadel/pkg/grpc/user/v2beta;userb\x06proto3"

var (
	file_zitadel_user_v2beta_idp_proto_rawDescOnce sync.Once
	file_zitadel_user_v2beta_idp_proto_rawDescData []byte
)

func file_zitadel_user_v2beta_idp_proto_rawDescGZIP() []byte {
	file_zitadel_user_v2beta_idp_proto_rawDescOnce.Do(func() {
		file_zitadel_user_v2beta_idp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_user_v2beta_idp_proto_rawDesc), len(file_zitadel_user_v2beta_idp_proto_rawDesc)))
	})
...
var file_zitadel_user_v2beta_idp_proto_goTypes = []any{
...
func file_zitadel_user_v2beta_idp_proto_init() {
	...
	file_zitadel_user_v2beta_idp_proto_msgTypes[3].OneofWrappers = []any{
		(*IDPInformation_Oauth)(nil),
		(*IDPInformation_Ldap)(nil),
		(*IDPInformation_Saml)(nil),
	}
	file_zitadel_user_v2beta_idp_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_user_v2beta_idp_proto_rawDesc), len(file_zitadel_user_v2beta_idp_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
