...
const file_zitadel_user_v2_user_proto_rawDesc = "" +
	"\n" +
	"\x1azitadel/user/v2/user.proto\x12\x0fzitadel.user.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x17validate/validate.proto\x1a\x1ezitadel/object/v2/object.proto\x1a\x1bzitadel/user/v2/email.proto\x1a\x1bzitadel/user/v2/phone.proto\"\xed\x03\n" +
	...
	"\x05value\x18\x02 \x01(\fB^\x92AL2#The value has to be base64 encoded.J\x1e\"VGhpcyBpcyBteSB0ZXN0IHZhbHVl\"x\xa0\xc2\x1e\x80\x01\x01\xe2A\x01\x02\xfaB\bz\x06\x10\x01\x18\xa0\xc2\x1eR\x05value\"\xdc\x05\n" +
	"\tHumanUser\x12D\n" +
