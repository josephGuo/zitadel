...
const file_zitadel_user_v2_password_proto_rawDesc = "" +
	"\n" +
	...
	"\r_url_template\"\x19\n" +
	"\x17ReturnPasswordResetCode\"\xa0\x03\n" +
	"\vSetPassword\x127\n" +
	"\bpassword\x18\x01 \x01(\v2\x19.zitadel.user.v2.PasswordH\x00R\bpassword\x12J\n" +
	"\x0fhashed_password\x18\x02 \x01(\v2\x1f.zitadel.user.v2.HashedPasswordH\x00R\x0ehashedPassword\x12W\n" +
	"\x10current_password\x18\x03 \x01(\tB*\x92A\x19J\x11\"Secr3tP4ssw0rd!\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01H\x01R\x0fcurrentPassword\x12\x91\x01\n" +
	"\x11verification_code\x18\x04 \x01(\tBb\x92AR2?\"the verification code generated during password reset request\"J\n" +
	"\"SKJd342k\"x\x14\x80\x01\x01\xe2A\x01\x02\xfaB\x06r\x04\x10\x01\x18\x14H\x01R\x10verificationCodeB\x0f\n" +
	"\rpassword_typeB\x0e\n" +
	"\fverification*m\n" +
	"\x10NotificationType\x12!\n" +
	"\x1dNOTIFICATION_TYPE_Unspecified\x10\x00\x12\x1b\n" +
	"\x17NOTIFICATION_TYPE_Email\x10\x01\x12\x19\n" +
	"\x15NOTIFICATION_TYPE_SMS\x10\x02B2Z0github.com/zitadel/zitadel/pkg/grpc/user/v2;userb\x06proto3"

var (
	file_zitadel_user_v2_password_proto_rawDescOnce sync.Once
	file_zitadel_user_v2_password_proto_rawDescData []byte
)

func file_zitadel_user_v2_password_proto_rawDescGZIP() []byte {
	file_zitadel_user_v2_password_proto_rawDescOnce.Do(func() {
		file_zitadel_user_v2_password_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_user_v2_password_proto_rawDesc), len(file_zitadel_user_v2_password_proto_rawDesc)))
	})
...
var file_zitadel_user_v2_password_proto_goTypes = []any{
...
func file_zitadel_user_v2_password_proto_init() {
	...
	file_zitadel_user_v2_password_proto_msgTypes[2].OneofWrappers = []any{}
	file_zitadel_user_v2_password_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_user_v2_password_proto_rawDesc), len(file_zitadel_user_v2_password_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
