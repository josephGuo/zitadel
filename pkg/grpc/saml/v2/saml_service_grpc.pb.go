...
func (c *sAMLServiceClient) GetSAMLRequest(ctx context.Context, in *GetSAMLRequestRequest, opts ...grpc.CallOption) (*GetSAMLRequestResponse, error) {
	...
	err := c.cc.Invoke(ctx, SAMLService_GetSAMLRequest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sAMLServiceClient) CreateResponse(ctx context.Context, in *CreateResponseRequest, opts ...grpc.CallOption) (*CreateResponseResponse, error) {
	...
	err := c.cc.Invoke(ctx, SAMLService_CreateResponse_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSAMLServiceServer must be embedded to have
...
func (UnimplementedSAMLServiceServer) GetSAMLRequest(context.Context, *GetSAMLRequestRequest) (*GetSAMLRequestResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSAMLRequest not implemented")
}
...
func (UnimplementedSAMLServiceServer) testEmbeddedByValue()                     {}
...
func RegisterSAMLServiceServer(s grpc.ServiceRegistrar, srv SAMLServiceServer) {
	// If the following call panics, it indicates UnimplementedSAMLServiceServer was
