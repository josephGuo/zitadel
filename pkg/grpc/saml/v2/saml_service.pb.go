...
const file_zitadel_saml_v2_saml_service_proto_rawDesc = "" +
	...
	"\x15GetSAMLRequestRequest\x12U\n" +
	"\x0fsaml_request_id\x18\x01 \x01(\tB-\x92A\x1cJ\x14\"163840776835432705\"x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\rsamlRequestId\"Y\n" +
	"\x16GetSAMLRequestResponse\x12?\n" +
	"\fsaml_request\x18\x01 \x01(\v2\x1c.zitadel.saml.v2.SAMLRequestR\vsamlRequest\"\xf1\x01\n" +
	"\x15CreateResponseRequest\x12O\n" +
	"\x0fsaml_request_id\x18\x01 \x01(\tB'\x92A\x16J\x14\"163840776835432705\"\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\rsamlRequestId\x124\n" +
	...
	"\rresponse_kind\x12\x03\xf8B\x01\"\x95\x01\n" +
	"\aSession\x12L\n" +
	"\n" +
	...
	"\rsession_token\x18\x02 \x01(\tB\x17\x92A\x06x\xc8\x01\x80\x01\x01\xe2A\x01\x02\xfaB\ar\x05\x10\x01\x18\xc8\x01R\fsessionToken\"\x87\x02\n" +
