...
const file_zitadel_authorization_v2beta_authorization_service_proto_rawDesc = "" +
	"\n" +
	"8zitadel/authorization/v2beta/authorization_service.proto\x12\x1czitadel.authorization.v2beta\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a+zitadel/protoc_gen_zitadel/v2/options.proto\x1a0zitadel/authorization/v2beta/authorization.proto\x1a\"zitadel/filter/v2beta/filter.proto\"\xf9\x02\n" +
	"\x19ListAuthorizationsRequest\x12M\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2(.zitadel.filter.v2beta.PaginationRequestH\x00R\n" +
	"pagination\x88\x01\x01\x12\x96\x01\n" +
	"\x0esorting_column\x18\x02 \x01(\x0e24.zitadel.authorization.v2beta.AuthorizationFieldNameB4\x92A):'\"AUTHORIZATION_FIELD_NAME_CREATED_DATE\"\xfaB\x05\x82\x01\x02\x10\x01H\x01R\rsortingColumn\x88\x01\x01\x12R\n" +
	"\afilters\x18\x03 \x03(\v28.zitadel.authorization.v2beta.AuthorizationsSearchFilterR\afiltersB\r\n" +
	"\v_paginationB\x11\n" +
	"\x0f_sorting_column\"\xbc\x01\n" +
	"\x1aListAuthorizationsResponse\x12I\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2).zitadel.filter.v2beta.PaginationResponseR\n" +
	"pagination\x12S\n" +
	"\x0eauthorizations\x18\x02 \x03(\v2+.zitadel.authorization.v2beta.AuthorizationR\x0eauthorizations\"\xdd\x02\n" +
	"\x1aCreateAuthorizationRequest\x12B\n" +
	"\auser_id\x18\x01 \x01(\tB)\x92A\x1cJ\x14\"163840776835432345\"x\xc8\x01\x80\x01\x01\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x06userId\x12H\n" +
	"\n" +
	"project_id\x18\x02 \x01(\tB)\x92A\x1cJ\x14\"163840776835432345\"x\xc8\x01\x80\x01\x01\xfaB\ar\x05\x10\x01\x18\xc8\x01R\tprojectId\x12R\n" +
	"\x0forganization_id\x18\x03 \x01(\tB$\x92A\x19J\x14\"163840776835432345\"x\xc8\x01\xfaB\x05r\x03\x18\xc8\x01H\x00R\x0eorganizationId\x88\x01\x01\x12I\n" +
	"\trole_keys\x18\x04 \x03(\tB,\x92A\x18J\x10[\"user\",\"admin\"]x\xc8\x01\x80\x01\x01\xfaB\x0e\x92\x01\v\x18\x01\"\ar\x05\x10\x01\x18\xc8\x01R\broleKeysB\x12\n" +
	"\x10_organization_id\"\xa9\x01\n" +
	...
	"changeDate\"W\n" +
	"\x1aDeleteAuthorizationRequest\x129\n" +
	"\x02id\x18\x01 \x01(\tB)\x92A\x1cJ\x14\"163840776835432345\"x\xc8\x01\x80\x01\x01\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x02id\"\x7f\n" +
	"\x1bDeleteAuthorizationResponse\x12`\n" +
	"\rdeletion_date\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x1f\x92A\x1cJ\x1a\"2024-12-18T07:50:47.492Z\"R\fdeletionDate\"Y\n" +
	"\x1cActivateAuthorizationRequest\x129\n" +
	"\x02id\x18\x01 \x01(\tB)\x92A\x1cJ\x14\"163840776835432345\"x\xc8\x01\x80\x01\x01\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x02id\"}\n" +
	"\x1dActivateAuthorizationResponse\x12\\\n" +
	"\vchange_date\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x1f\x92A\x1cJ\x1a\"2024-12-18T07:50:47.492Z\"R\n" +
	"changeDate\"[\n" +
	"\x1eDeactivateAuthorizationRequest\x129\n" +
	"\x02id\x18\x01 \x01(\tB)\x92A\x1cJ\x14\"163840776835432345\"x\xc8\x01\x80\x01\x01\xfaB\ar\x05\x10\x01\x18\xc8\x01R\x02id\"\x7f\n" +
	"\x1fDeactivateAuthorizationResponse\x12\\\n" +
	"\vchange_date\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x1f\x92A\x1cJ\x1a\"2024-12-18T07:50:47.492Z\"R\n" +
	"changeDate2\xcb\x0f\n" +
	"\x14AuthorizationService\x12\xa3\x02\n" +
	"\x12ListAuthorizations\x127.zitadel.authorization.v2beta.ListAuthorizationsRequest\x1a8.zitadel.authorization.v2beta.ListAuthorizationsResponse\"\x99\x01\x92AYJ8\n" +
	"\x03200\x121\n" +
	"/A list of all authorizations matching the queryJ\x1b\n" +
	"\x03400\x12\x14\n" +
	"\x12invalid list queryX\x01\x8a\xb5\x18\x11\n" +
	"\x0f\n" +
	"\rauthenticated\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/v2beta/authorizations/search\x12\xdd\x02\n" +
	"\x13CreateAuthorization\x128.zitadel.authorization.v2beta.CreateAuthorizationRequest\x1a9.zitadel.authorization.v2beta.CreateAuthorizationResponse\"\xd0\x01\x92A\x96\x01J(\n" +
	"\x03200\x12!\n" +
	"\x1fThe newly created authorizationJ\x1f\n" +
	"\x03400\x12\x18\n" +
	"\x16invalid create requestJG\n" +
	"\x03409\x12@\n" +
	"!The authorization already exists.\x12\x1b\n" +
	"\x19\x1a\x17#/definitions/rpcStatusX\x01\x8a\xb5\x18\x11\n" +
	"\x0f\n" +
	"\rauthenticated\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v2beta/authorizations\x12\xb1\x02\n" +
	"\x13UpdateAuthorization\x128.zitadel.authorization.v2beta.UpdateAuthorizationRequest\x1a9.zitadel.authorization.v2beta.UpdateAuthorizationResponse\"\xa4\x01\x92AfJ\v\n" +
	"\x03200\x12\x04\n" +
	"\x02OKJU\n" +
	"\x03404\x12N\n" +
	"/Authorization or one of the roles do not exist.\x12\x1b\n" +
	"\x19\x1a\x17#/definitions/rpcStatusX\x01\x8a\xb5\x18\x11\n" +
	"\x0f\n" +
	"\rauthenticated\x82\xd3\xe4\x93\x02 :\x01*2\x1b/v2beta/authorizations/{id}\x12\xc0\x02\n" +
	"\x13DeleteAuthorization\x128.zitadel.authorization.v2beta.DeleteAuthorizationRequest\x1a9.zitadel.authorization.v2beta.DeleteAuthorizationResponse\"\xb3\x01\x92AxJ4\n" +
	"\x03200\x12-\n" +
	"+The authorization was deleted successfully.J>\n" +
	"\x03404\x127\n" +
	"\x18Authorization not found.\x12\x1b\n" +
	"\x19\x1a\x17#/definitions/rpcStatusX\x01\x8a\xb5\x18\x11\n" +
	"\x0f\n" +
	"\rauthenticated\x82\xd3\xe4\x93\x02\x1d*\x1b/v2beta/authorizations/{id}\x12\xd4\x02\n" +
	"\x15ActivateAuthorization\x12:.zitadel.authorization.v2beta.ActivateAuthorizationRequest\x1a;.zitadel.authorization.v2beta.ActivateAuthorizationResponse\"\xc1\x01\x92AzJ6\n" +
	"\x03200\x12/\n" +
	"-The authorization was activated successfully.J>\n" +
	"\x03404\x127\n" +
	"\x18Authorization not found.\x12\x1b\n" +
	"\x19\x1a\x17#/definitions/rpcStatusX\x01\x8a\xb5\x18\x11\n" +
	"\x0f\n" +
	"\rauthenticated\x82\xd3\xe4\x93\x02):\x01*\"$/v2beta/authorizations/{id}/activate\x12\xde\x02\n" +
	"\x17DeactivateAuthorization\x12<.zitadel.authorization.v2beta.DeactivateAuthorizationRequest\x1a=.zitadel.authorization.v2beta.DeactivateAuthorizationResponse\"\xc5\x01\x92A|J8\n" +
	"\x03200\x121\n" +
	"/The authorization was deactivated successfully.J>\n" +
	"\x03404\x127\n" +
	"\x18Authorization not found.\x12\x1b\n" +
	"\x19\x1a\x17#/definitions/rpcStatusX\x01\x8a\xb5\x18\x11\n" +
	"\x0f\n" +
	"\rauthenticated\x82\xd3\xe4\x93\x02+:\x01*\"&/v2beta/authorizations/{id}/deactivateBHZFgithub.com/zitadel/zitadel/pkg/grpc/authorization/v2beta;authorizationb\x06proto3"

var (
	file_zitadel_authorization_v2beta_authorization_service_proto_rawDescOnce sync.Once
	file_zitadel_authorization_v2beta_authorization_service_proto_rawDescData []byte
)
...
func file_zitadel_authorization_v2beta_authorization_service_proto_rawDescGZIP() []byte {
	file_zitadel_authorization_v2beta_authorization_service_proto_rawDescOnce.Do(func() {
		file_zitadel_authorization_v2beta_authorization_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zitadel_authorization_v2beta_authorization_service_proto_rawDesc), len(file_zitadel_authorization_v2beta_authorization_service_proto_rawDesc)))
	})
...
var file_zitadel_authorization_v2beta_authorization_service_proto_goTypes = []any{
...
func file_zitadel_authorization_v2beta_authorization_service_proto_init() {
	...
	file_zitadel_authorization_v2beta_authorization_service_proto_msgTypes[0].OneofWrappers = []any{}
	file_zitadel_authorization_v2beta_authorization_service_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zitadel_authorization_v2beta_authorization_service_proto_rawDesc), len(file_zitadel_authorization_v2beta_authorization_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   1,
